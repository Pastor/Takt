...
#
# ⚠️ ИМЕНА В ПОРОЖДАЕМОМ КОДЕ ГЕЙТ ПРОВЕРЯЕТ ТОЖЕ (фича 0253). До неё этот
...
# пользователя. Фича 0253 переименовала их в `takt_q_*`/`TAKT_Q_*` и сняла
# исключение — шаблон ниже ловит старый префикс в любом регистре, включая
# снапшоты `examples/generated/`. Сторож этой ветви — мутация в
