...
static const InPortEntry in_port_table[] = {
    /* Кнопки кабины */
    { "CabinButton_DC",            ELEVATOR_MINI_CABIN_PORT_CABIN_BUTTON_DC  },
    { "CabinButton_DO",            ELEVATOR_MINI_CABIN_PORT_CABIN_BUTTON_DO  },
    { "CabinButton_F1",            ELEVATOR_MINI_CABIN_PORT_CABIN_BUTTON_F1  },
    { "CabinButton_F2",            ELEVATOR_MINI_CABIN_PORT_CABIN_BUTTON_F2  },
    { "CabinButton_F3",            ELEVATOR_MINI_CABIN_PORT_CABIN_BUTTON_F3  },
    { "CabinButton_F4",            ELEVATOR_MINI_CABIN_PORT_CABIN_BUTTON_F4  },
    { "CabinButton_F5",            ELEVATOR_MINI_CABIN_PORT_CABIN_BUTTON_F5  },
    { "CabinButton_F6",            ELEVATOR_MINI_CABIN_PORT_CABIN_BUTTON_F6  },
    { "CabinButton_F7",            ELEVATOR_MINI_CABIN_PORT_CABIN_BUTTON_F7  },
    { "CabinButton_F8",            ELEVATOR_MINI_CABIN_PORT_CABIN_BUTTON_F8  },
    { "CabinButton_F9",            ELEVATOR_MINI_CABIN_PORT_CABIN_BUTTON_F9  },
    /* Кнопки вызова на этажах */
    { "FloorButton_F1",            ELEVATOR_MINI_CABIN_PORT_FLOOR_BUTTON_F1  },
    { "FloorButton_F2",            ELEVATOR_MINI_CABIN_PORT_FLOOR_BUTTON_F2  },
    { "FloorButton_F3",            ELEVATOR_MINI_CABIN_PORT_FLOOR_BUTTON_F3  },
    { "FloorButton_F4",            ELEVATOR_MINI_CABIN_PORT_FLOOR_BUTTON_F4  },
    { "FloorButton_F5",            ELEVATOR_MINI_CABIN_PORT_FLOOR_BUTTON_F5  },
    { "FloorButton_F6",            ELEVATOR_MINI_CABIN_PORT_FLOOR_BUTTON_F6  },
    { "FloorButton_F7",            ELEVATOR_MINI_CABIN_PORT_FLOOR_BUTTON_F7  },
    { "FloorButton_F8",            ELEVATOR_MINI_CABIN_PORT_FLOOR_BUTTON_F8  },
    { "FloorButton_F9",            ELEVATOR_MINI_CABIN_PORT_FLOOR_BUTTON_F9  },
    /* Датчики зоны этажа: нижняя граница */
    { "FloorSensor_F1_Bottom",     ELEVATOR_MINI_CABIN_PORT_FLOOR_SENSOR_F1_BOTTOM },
    { "FloorSensor_F2_Bottom",     ELEVATOR_MINI_CABIN_PORT_FLOOR_SENSOR_F2_BOTTOM },
    { "FloorSensor_F3_Bottom",     ELEVATOR_MINI_CABIN_PORT_FLOOR_SENSOR_F3_BOTTOM },
    { "FloorSensor_F4_Bottom",     ELEVATOR_MINI_CABIN_PORT_FLOOR_SENSOR_F4_BOTTOM },
    { "FloorSensor_F5_Bottom",     ELEVATOR_MINI_CABIN_PORT_FLOOR_SENSOR_F5_BOTTOM },
    { "FloorSensor_F6_Bottom",     ELEVATOR_MINI_CABIN_PORT_FLOOR_SENSOR_F6_BOTTOM },
    { "FloorSensor_F7_Bottom",     ELEVATOR_MINI_CABIN_PORT_FLOOR_SENSOR_F7_BOTTOM },
    { "FloorSensor_F8_Bottom",     ELEVATOR_MINI_CABIN_PORT_FLOOR_SENSOR_F8_BOTTOM },
    { "FloorSensor_F9_Bottom",     ELEVATOR_MINI_CABIN_PORT_FLOOR_SENSOR_F9_BOTTOM },
    /* Датчики зоны этажа: верхняя граница */
    { "FloorSensor_F1_Top",        ELEVATOR_MINI_CABIN_PORT_FLOOR_SENSOR_F1_TOP    },
    { "FloorSensor_F2_Top",        ELEVATOR_MINI_CABIN_PORT_FLOOR_SENSOR_F2_TOP    },
    { "FloorSensor_F3_Top",        ELEVATOR_MINI_CABIN_PORT_FLOOR_SENSOR_F3_TOP    },
    { "FloorSensor_F4_Top",        ELEVATOR_MINI_CABIN_PORT_FLOOR_SENSOR_F4_TOP    },
    { "FloorSensor_F5_Top",        ELEVATOR_MINI_CABIN_PORT_FLOOR_SENSOR_F5_TOP    },
    { "FloorSensor_F6_Top",        ELEVATOR_MINI_CABIN_PORT_FLOOR_SENSOR_F6_TOP    },
    { "FloorSensor_F7_Top",        ELEVATOR_MINI_CABIN_PORT_FLOOR_SENSOR_F7_TOP    },
    { "FloorSensor_F8_Top",        ELEVATOR_MINI_CABIN_PORT_FLOOR_SENSOR_F8_TOP    },
    { "FloorSensor_F9_Top",        ELEVATOR_MINI_CABIN_PORT_FLOOR_SENSOR_F9_TOP    },
    /* Концевые датчики мотора */
    { "ElevatorMotor_SensorD",     ELEVATOR_MINI_MOTOR_PORT_ELEVATOR_MOTOR_SENSOR_D },
    { "ElevatorMotor_SensorU",     ELEVATOR_MINI_MOTOR_PORT_ELEVATOR_MOTOR_SENSOR_U },
};
...
static const OutPortEntry out_port_table[] = {
    { "DoorOpen",              ELEVATOR_MINI_CABIN_PORT_DOOR_OPEN              },
    { "ElevatorMotor_Down",    ELEVATOR_MINI_MOTOR_PORT_ELEVATOR_MOTOR_DOWN    },
    { "ElevatorMotor_Stop",    ELEVATOR_MINI_MOTOR_PORT_ELEVATOR_MOTOR_STOP    },
    { "ElevatorMotor_Up",      ELEVATOR_MINI_MOTOR_PORT_ELEVATOR_MOTOR_UP      },
};
