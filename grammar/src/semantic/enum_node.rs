//! Семантический узел перечисления (`enum`) языка Lam.
//!
...
///
/// # Пример Lam (концептуально, поддержка на семантическом уровне)
///
/// ```text
/// // enum Color { Red = 0, Green = 1, Blue = 2 }
/// ```
///
/// Фактически перечисления сейчас не имеют синтаксиса в грамматике Lam,
