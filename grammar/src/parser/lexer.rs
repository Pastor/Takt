//! Лексический анализатор языка Lam.
//!
//! Этот модуль реализует ручной лексер для языка Lam на базе итератора
...
/// Возвращает `true`, если переданная строка является ключевым словом Lam.
pub fn is_keyword(word: &str) -> bool {
    KEYWORDS.contains_key(word)
}

/// Статическая таблица ключевых слов языка Lam.
///
