...
//!
//! Тест печатает **сводку покрытия**: сколько файлов корпуса форматируется. Пока
//! ядро неполно (комментарии — задача 0024-02), сводка — честная метрика
//! прогресса, а не «зелёный тест».
