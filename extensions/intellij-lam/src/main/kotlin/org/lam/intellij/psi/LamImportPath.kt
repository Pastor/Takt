 ...
 * целевого файла средствами IDEA путь в `.lam` обновляется (через
 * `LamImportPathManipulator`, регистрируемый в `plugin.xml`).
 *
 ...
 */
class LamImportPath(node: ASTNode) : ASTWrapperPsiElement(node) {
    ...
    override fun getReferences(): Array<PsiReference> {
        ...
        return LamImportFileReferenceSet(content, this).allReferences as Array<PsiReference>
    }
}
 ...
 */
private class LamImportFileReferenceSet(str: String, element: LamImportPath) :
