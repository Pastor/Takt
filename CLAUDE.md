...
- **Симулятор починен (фича 0025, вердикт отчёта — на доработку).** Выражения, условия,
  ...
  отчёт (стадия 6) дал вердикт **на доработку** — не выполнены пункты тест-плана
  (фикстуры `simulation/tests/data/eval/`, интеграционный слой, примеры в README,
  автосверка с C): задачи `0025-06`…`0025-08`. Ошибка вычисления доходит до CLI:
