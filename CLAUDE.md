...
- Читай PROMPT.md первым, перечисли все задачи, выполняй последовательно. После каждой задачи запускай cargo test перед
...
- После завершения каждой задачи из PROMPT.md добавляй однострочную запись в STATUS.md (название задачи, изменённые
...
- Прочитай PROMPT.md и определи все независимые задачи. Для каждой независимой задачи запусти параллельного субагента
