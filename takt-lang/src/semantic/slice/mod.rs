//! Границы среза массива — общий носитель (фичи 0355, 0400).
//!
...
//!
//! ⚠️ **Модуль живёт в семантике, а не в генераторе** (фича 0400): границы
//! среза — свойство **языка**, и разворот среза в аргументе вызова
//! (`semantic/slice_argument.rs`) спрашивает те же значения, что печатники
//! целей. Пока носитель лежал в `generator/`, семантика не могла его позвать,
//! не перевернув слои.
//!
//! # Что было
//!
