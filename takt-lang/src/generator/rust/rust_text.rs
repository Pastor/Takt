...
//!
//! Вынесено из `rust_expr` по границе ответственности (правило размера
//! модуля): там строится выражение из семантического узла, здесь — работа со
//! строкой, которая узлов не знает вовсе.
