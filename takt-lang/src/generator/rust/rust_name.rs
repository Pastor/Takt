//! Отображение имён Lam в идентификаторы Rust (задача 0050-04).
//!
//! Правила:
//!
...
//! (наследие [ADR 0028](../../../../docs/adr/0028-c-generator-stubs.md)).
//!
    ...
    Diagnostic::error(
        ...
        format!(
            "Имя '{}' даёт идентификатор '{}', непредставимый в Rust: \
             ...
             правилом языка. Переименуйте элемент в исходнике .lam",
    ...
    Diagnostic::error(
        ...
        format!(
            "{}: имена '{}' и '{}' после приведения регистра дают один \
             идентификатор '{}'. Переименуйте одно из них в исходнике .lam",
