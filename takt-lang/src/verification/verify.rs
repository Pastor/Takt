...
pub enum UnsupportedReason {
    ...
    /// Проверено на четырёх входах: `float`, `q(4, 4)`, `[bit; 8]`, структура.
    ...
    pub const fn text(self) -> &'static str {
        match self {
            ...
            Self::PredicateOutsideSubset => concat!(
                ...
                "неперечислимый тип (`float`, `q`, массив, структура) — ",
            ...
            Self::DomainNotEnumerable => concat!(
                ...
                "массив или структура — проверка перебирает значения, а перебирать ",
                "здесь нечего"
            ),
