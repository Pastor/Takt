...
> **Части 1–3 реализованы 2026-07-15.** Часть 3 сняла блокер «функции читают
> состояние модели» и **область видимости FB**. Осталась только **последовательная
> композиция `M1 + M2`** (часть 4).
>
...
**Гейт зелёный на всём, что генерируется.** Впервые с начала фичи порождённый ST
не просто печатается, а **компилируется** транспилятором IEC 61131-3.
