...
| 0306-01 | 0306 | Невычислимый вызов функции в инициализаторе называет причину | [0306-01-unfoldable-call-in-initializer.md](0306-01-unfoldable-call-in-initializer.md) |
| 0307-01 | 0307 | Текст SIM-011 называет ширину значения | [0307-01-sim-bit-range-text.md](0307-01-sim-bit-range-text.md) |
...
| 0312-01 | 0312 | Гейты цели c проверяют и релизный режим | [0312-01-c-gate-release-mode.md](0312-01-c-gate-release-mode.md) |
| 0313-01 | 0313 | Число аргументов вызова сверяется с объявлением | [0313-01-call-arity-check.md](0313-01-call-arity-check.md) |
...
| 0342-01 | 0342 | Список зарезервированных имён IEC проверяется прогоном | [0342-01-st-reserved-names.md](0342-01-st-reserved-names.md) |
| 0343-01 | 0343 | Инициализатор массива: st терял молча, c и rust порождали невалидное | [0343-01-array-initializer.md](0343-01-array-initializer.md) |
| 0344-01 | 0344 | Порядок функций у цели st — по зависимостям вызова | [0344-01-st-call-order.md](0344-01-st-call-order.md) |
| 0345-01 | 0345 | Агрегат в локальном объявлении переводят все цели | [0345-01-local-aggregate.md](0345-01-local-aggregate.md) |
...
| 0350-01 | 0350 | Порт составного типа: отказ вместо невалидного вывода | [0350-01-port-composite-type.md](0350-01-port-composite-type.md) |
...
| 0357-01 | 0357 | Умолчание общей переменной строит один носитель | [0357-01-rust-shared-default-value.md](0357-01-rust-shared-default-value.md) |
| 0358-01 | 0358 | Индексация применима к выражению, а не только к имени | [0358-01-postfix-index-on-expression.md](0358-01-postfix-index-on-expression.md) |
| 0359-01 | 0359 | Сравнение знакового с беззнаковым | [0359-01-mixed-sign-comparison.md](0359-01-mixed-sign-comparison.md) |
| 0360-01 | 0360 | Арифметика операндов разной знаковости | [0360-01-mixed-sign-arithmetic.md](0360-01-mixed-sign-arithmetic.md) |
| 0361-01 | 0361 | Приведение к тому же типу опускается | [0361-01-same-type-cast.md](0361-01-same-type-cast.md) |
| 0362-01 | 0362 | Проба прогоняет инструменты целей | [0362-01-probe-target-tools.md](0362-01-probe-target-tools.md) |
...
| 0376-01 | 0376 | Неиспользуемая локальная переменная гасится заглушкой | [0376-01-unused-local-stub.md](0376-01-unused-local-stub.md) |
| 0377-01 | 0377 | Артефакты сборки не попадают в репозиторий | [0377-01-build-artifacts-gate.md](0377-01-build-artifacts-gate.md) |
| 0378-01 | 0378 | Имя переменной, совпавшее с именем типа, у цели st | [0378-01-st-name-type-clash.md](0378-01-st-name-type-clash.md) |
| 0379-01 | 0379 | Сброс перечислимого регистра у цели sv | [0379-01-sv-enum-reset.md](0379-01-sv-enum-reset.md) |
...
| 0389-01 | 0389 | Массив в параметре функции цели rust — по ссылке | [0389-01-rust-array-by-reference.md](0389-01-rust-array-by-reference.md) |
