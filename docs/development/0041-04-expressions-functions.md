...
> **Часть 1 реализована 2026-07-15: выражения и условия** (`st_expr.rs`, 14
> юнит-тестов). **Часть 2 реализована 2026-07-15: операторы** (`st_stmt.rs`, 10
> юнит-тестов; `InlineFormula` → `ST-010`). **Часть 3 не начата:** функции
> (`FUNCTION`/`RETURN`), `extern fn` + `ST-009`.
...
[обзоре](../analyze/0041-st-backend.md): `… → 0041-02 → **0041-04 → 0041-03** → …`.
