...
| [0240](./0240-book-typst.md) | Перевод документа book/ в формат Typst | Accepted | фича 0240 |
...
| [0246](./0246-init-forward-reference.md) | Ссылка вперёд в инициализаторе переменной — ошибка компиляции | Accepted | фича 0246 |
...
| [0218](./0218-registry-verdict-placeholder.md) | Реестры стадий 5 и 6 хранят заготовочное СОЗДАНА в колонках вердикта | Accepted | фича 0218 |
| [0217](./0217-stub-branch-gate.md) | Ветвь-заглушка до будущей задачи переживает саму задачу | Accepted | фича 0217 |
| [0248](./0248-sim-builtin-functions.md) | Встроенные функции min/max/abs/clamp/debug не исполняются эталоном | Accepted | фича 0248 |
| [0247](./0247-sim-bare-state-condition.md) | Голое имя состояния и модели в условии не исполняется эталоном | Accepted | фича 0247 |
| [0249](./0249-assign-to-call-place.md) | Левая часть присваивания — место записи | Draft | фича 0249 |
| [0250](./0250-bit-write-in-targets.md) | Запись бита x.N := v работает или отказывает по названной причине | Draft | фича 0250 |
| [0145](./0145-verify-vertex-budget.md) | Потолок верификации по данным считается по рёбрам, а не по вершинам | Accepted (Option C) | фича 0145 |
| [0153](./0153-lsp-workspace-index.md) | Рабочая область сканируется по требованию, а не индексируется | Accepted (Option C) | фича 0153 |
...
| [0301](./0301-probe-checklist.md) | Снятие замера расхождения: инструмент и чек-лист | Accepted | фича 0301 |
| [0302](./0302-release-on-language-minor.md) | Релиз и тег при подъёме минорной версии языка | Accepted | фича 0302 |
...
| [0308](./0308-target-refusal-position.md) | Позиция оператора — общий потоковый носитель | Accepted | фича 0308 |
| [0309](./0309-sv-array-initializer.md) | Агрегат массива в цели sv — шаблон присваивания | Accepted | фича 0309 |
| [0310](./0310-int-cast-shared-layer.md) | Правило целочисленного приведения — общий носитель | Accepted | фича 0310 |
| [0311](./0311-diagnostic-descriptions.md) | Запись реестра диагностик обязана называть смысл | Accepted | фича 0311 |
| [0312](./0312-c-gate-release-mode.md) | Гейты цели c проверяют и релизный режим | Accepted | фича 0312 |
| [0313](./0313-call-arity-check.md) | Арность вызова проверяет семантика | Accepted | фича 0313 |
| [0314](./0314-c-dropped-builtin-warning.md) | Выброшенный вызов встроенной функции — предупреждение CC-024 | Accepted | фича 0314 |
| [0315](./0315-gate-guards.md) | Гейт без сторожа неотличим от гейта, который не смотрит | Accepted | фича 0315 |
| [0316](./0316-precheck-comment-duplication.md) | Комментарий шага объясняет шаг, правило живёт в гейте | Accepted | фича 0316 |
| [0317](./0317-fixed-cast-shared-layer.md) | Правило представления q(m, n) — общий носитель | Accepted | фича 0317 |
| [0318](./0318-duration-cast-folding.md) | Мост «число ↔ длительность» считает компилятор | Accepted | фича 0318 |
...
| [0326](./0326-rust-shift-width.md) | Сдвиг на ширину типа печатается насыщенным | Accepted | фича 0326 |
| [0327](./0327-sv002-description.md) | Описание кода отражает нынешний состав отказов | Accepted | фича 0327 |
| [0328](./0328-integer-power.md) | Целая степень считается целочисленно | Accepted | фича 0328 |
| [0329](./0329-power-in-rust-sv.md) | Целая степень в целях rust и sv | Accepted | фича 0329 |
| [0330](./0330-aggregate-assignment.md) | Присваивание агрегата печатается поэлементно | Accepted | фича 0330 |
| [0331](./0331-named-condition-in-body.md) | Именованное условие в теле — то же условие | Accepted | фича 0331 |
| [0332](./0332-stub-task-promise.md) | Обещание задачи в тексте диагностики — тоже заглушка | Accepted | фича 0332 |
| [0333](./0333-book-runtime-errors.md) | Документ называет, где симулятор строже прошивки | Accepted | фича 0333 |
| [0334](./0334-rust-variable-shift-width.md) | Сдвиг на величину не меньше ширины типа в цели `rust` | Accepted | фича 0334 |
| [0335](./0335-bit-value-in-targets.md) | Разряд в позиции числового значения переводят все цели | Accepted | фича 0335 |
| [0336](./0336-call-return-coercion.md) | Приведение к типу приёмника в аргументе и возврате функции | Accepted | фича 0336 |
| [0337](./0337-unused-function-parameter.md) | Неиспользуемый параметр функции гасится у трёх целей | Accepted | фича 0337 |
| [0338](./0338-enum-in-function.md) | Перечисление внутри функции у целей `st` и `sv` | Accepted | фича 0338 |
| [0339](./0339-sv-refusal-template.md) | Шаблон отказа цели `sv` — один носитель и читаемый текст | Accepted | фича 0339 |
| [0340](./0340-aggregate-assign-place.md) | Присваивание агрегата: место записи выбирает общий носитель | Accepted | фича 0340 |
| [0341](./0341-nested-struct-order.md) | Вложенная структура: порядок объявления и тип поля | Accepted | фича 0341 |
| [0342](./0342-st-reserved-names.md) | Список зарезервированных имён IEC проверяется прогоном | Accepted | фича 0342 |
| [0343](./0343-array-initializer.md) | Инициализатор массива у целей `st`, `c`, `rust` | Accepted | фича 0343 |
| [0344](./0344-st-call-order.md) | Порядок функций у цели `st` — по зависимостям вызова | Accepted | фича 0344 |
| [0345](./0345-local-aggregate.md) | Агрегат в локальном объявлении переводят все цели | Accepted | фича 0345 |
| [0346](./0346-array-param-index.md) | Индексация параметра-массива внутри функции | Accepted | фича 0346 |
| [0347](./0347-const-aggregate.md) | Константа структурного и массивного типа у `rust` и `sv` | Accepted | фича 0347 |
| [0348](./0348-st-array-parameter.md) | Массив в параметре функции у цели `st` | Accepted | фича 0348 |
...
| [0353](./0353-c-default-init.md) | Умолчание переменной у цели c печатается тем же путём, что инициализатор | Accepted | фича 0353 |
| [0354](./0354-sim-duration-default.md) | Умолчание типа строит один носитель, и вид значения — часть типа | Accepted | фича 0354 |
| [0355](./0355-array-slice-in-targets.md) | Срез печатается поэлементно, пригодность операндов решает носитель | Accepted | фича 0355 |
| [0356](./0356-sim-bit-in-arithmetic.md) | Разряд — число 0/1; правило S8 остаётся в силе | Accepted | фича 0356 |
| [0357](./0357-rust-shared-default-value.md) | Умолчание типа — один носитель даже в защитной ветви | Accepted | фича 0357 |
| [0358](./0358-postfix-index-on-expression.md) | Постфиксы применяются к выражению, тип базы даёт один носитель | Accepted | фича 0358 |
| [0359](./0359-mixed-sign-comparison.md) | Сравнение разной знаковости приводится к общему типу | Accepted | фича 0359 |
| [0360](./0360-mixed-sign-arithmetic.md) | Значение печатается в типе приёмника, приводятся операнды | Accepted | фича 0360 |
| [0361](./0361-same-type-cast.md) | Приведение, ничего не меняющее, в выводе не печатается | Accepted | фича 0361 |
| [0362](./0362-probe-target-tools.md) | Проба прогоняет инструменты целей | Draft | фича 0362 |
| [0363](./0363-st-multidim-subscript.md) | Индексация многомерного массива у цели st | Draft | фича 0363 |
| [0364](./0364-c-nested-array.md) | Вложенный массив у цели c | Draft | фича 0364 |
| [0365](./0365-sv-unpacked-array.md) | Распакованный массив у цели sv: сброс и переменный индекс | Draft | фича 0365 |
| [0366](./0366-nested-aggregate-carrier.md) | Раскрытие вложенного агрегата — общий носитель | Draft | фича 0366 |
| [0367](./0367-sv-struct-array.md) | Массив структур у цели sv синтезируется | Draft | фича 0367 |
| [0368](./0368-aggregate-element-type.md) | Элемент агрегата печатается по типу элемента | Draft | фича 0368 |
| [0369](./0369-sv-array-parameter.md) | Массив в параметре функции у цели sv | Draft | фича 0369 |
| [0370](./0370-struct-field-fixed.md) | Понижение q-литерала доходит до полей структуры | Draft | фича 0370 |
| [0371](./0371-fixed-cast-from-field.md) | Приведение q из поля структуры масштабируется | Draft | фича 0371 |
| [0372](./0372-composite-array-parameter.md) | Составной элемент массива в параметре функции | Draft | фича 0372 |
| [0373](./0373-sv-struct-local.md) | Локальная переменная структурного типа у цели sv | Draft | фича 0373 |
| [0374](./0374-mapped-type-cast.md) | Приведение, совпадающее после отображения типа | Draft | фича 0374 |
| [0375](./0375-sv-partial-struct-local.md) | Частично использованная локальная структура у цели sv | Draft | фича 0375 |
| [0376](./0376-unused-local-stub.md) | Неиспользуемая локальная переменная гасится заглушкой | Draft | фича 0376 |
| [0377](./0377-build-artifacts-gate.md) | Артефакты сборки не попадают в репозиторий | Draft | фича 0377 |
| [0378](./0378-st-name-type-clash.md) | Имя переменной, совпавшее с именем типа, у цели st | Draft | фича 0378 |
| [0379](./0379-sv-enum-reset.md) | Сброс перечислимого регистра у цели sv | Draft | фича 0379 |
| [0380](./0380-fixed-point-parameter.md) | Fixed-point в параметре функции | Draft | фича 0380 |
| [0381](./0381-fixed-literal-in-body.md) | Понижение q-литерала в телах и условиях | Draft | фича 0381 |
| [0382](./0382-fixed-literal-in-place.md) | Понижение q-литерала в поле структуры и элементе массива | Draft | фича 0382 |
| [0383](./0383-fixed-cast-literal-in-body.md) | Приведение дробного литерала к q(m, n) в теле | Draft | фича 0383 |
| [0384](./0384-fixed-cast-const.md) | Приведение имени константы к q(m, n) | Draft | фича 0384 |
| [0385](./0385-contextual-from.md) | Слово from — контекстное ключевое | Draft | фича 0385 |
| [0386](./0386-unused-local-warning.md) | SE-036 видит локальные объявления тел | Draft | фича 0386 |
| [0387](./0387-write-only-local.md) | Локальная переменная, записанная но не прочитанная | Draft | фича 0387 |
| [0388](./0388-st-decl-split.md) | Разделение печати объявлений цели st | Draft | фича 0388 |
| [0389](./0389-rust-array-by-reference.md) | Массив в параметре функции цели rust — по ссылке | Draft | фича 0389 |
| [0391](./0391-enum-default-value.md) | Умолчание переменной перечислимого типа: ноль против первого варианта | Draft | фича 0391 |
| [0394](./0394-bit-beyond-declared-width.md) | Разряд за объявленной шириной бит-вектора принимают молча | Draft | фича 0394 |
| [0390](./0390-port-composite-type-policy.md) | Порт составного типа: нормировать ли в семантике | Draft | фича 0390 |
| [0395](./0395-imported-model-specialization.md) | Специализация импортированной модели | Draft | фича 0395 |
| [0393](./0393-every-on-self-transition.md) | every при самопереходе | Draft | фича 0393 |
| [0392](./0392-c-shift-width-wide.md) | Сдвиг на величину, не меньшую ширины типа, в цели c | Draft | фича 0392 |
| [0397](./0397-state-of-neighbour-rust-st.md) | Форму S(Модель) = Состояние у соседа не переводят rust и st | Draft | фича 0397 |
| [0400](./0400-slice-in-call-argument.md) | Срез в аргументе вызова | Draft | фича 0400 |
| [0396](./0396-c-struct-parameter-on-demand.md) | x | Draft | фича 0396 |
| [0398](./0398-diagnostics-detailed-analysis.md) | x | Draft | фича 0398 |
| [0399](./0399-operand-type-single-carrier.md) | x | Draft | фича 0399 |
| [0401](./0401-lsp-imported-symbol-kind.md) | x | Draft | фича 0401 |
