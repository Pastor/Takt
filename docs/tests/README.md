...
| 0297 | Гейт живого контекста читает абзацы, а не строки | [0297-check-claude-md-line-blindness.md](0297-check-claude-md-line-blindness.md) | Пройден: 7/7 условий, мутация подтверждена |
...
| 0312 | Релизный режим в гейтах цели c | [0312-c-gate-release-mode.md](0312-c-gate-release-mode.md) | Пройден: 6/6 условий, найден дефект харнесса |
...
| 0343 | Инициализатор массива | [0343-array-initializer.md](0343-array-initializer.md) | Пройден: 6/6 условий, значения сверены |
| 0344 | Порядок функций у цели `st` | [0344-st-call-order.md](0344-st-call-order.md) | Пройден: 4/4 условия, мутация ловится |
| 0345 | Агрегат в локальном объявлении | [0345-local-aggregate.md](0345-local-aggregate.md) | Пройден: 5/5 условий, значения сверены |
| 0346 | Индексация параметра-массива | [0346-array-param-index.md](0346-array-param-index.md) | Пройден: 6/6 условий |
...
| 0358 | Индексация применима к выражению, а не только к имени | [0358-postfix-index-on-expression.md](0358-postfix-index-on-expression.md) | ГОТОВО (сверка с отчётом пройдена) |
| 0359 | Сравнение знакового с беззнаковым | [0359-mixed-sign-comparison.md](0359-mixed-sign-comparison.md) | ГОТОВО (сверка с отчётом пройдена) |
| 0360 | Арифметика операндов разной знаковости | [0360-mixed-sign-arithmetic.md](0360-mixed-sign-arithmetic.md) | ГОТОВО (сверка с отчётом пройдена) |
| 0361 | Приведение к тому же типу опускается | [0361-same-type-cast.md](0361-same-type-cast.md) | ГОТОВО (сверка с отчётом пройдена) |
| 0362 | Проба прогоняет инструменты целей | [0362-probe-target-tools.md](0362-probe-target-tools.md) | ГОТОВО (сверка с отчётом пройдена) |
| 0363 | Индексация многомерного массива у цели st | [0363-st-multidim-subscript.md](0363-st-multidim-subscript.md) | ГОТОВО (сверка с отчётом пройдена) |
| 0364 | Вложенный массив у цели c | [0364-c-nested-array.md](0364-c-nested-array.md) | ГОТОВО (сверка с отчётом пройдена) |
| 0365 | Распакованный массив у цели sv: сброс и переменный индекс | [0365-sv-unpacked-array.md](0365-sv-unpacked-array.md) | ГОТОВО (сверка с отчётом пройдена) |
| 0366 | Раскрытие вложенного агрегата — общий носитель | [0366-nested-aggregate-carrier.md](0366-nested-aggregate-carrier.md) | ГОТОВО (сверка с отчётом пройдена) |
| 0367 | Массив структур у цели sv синтезируется | [0367-sv-struct-array.md](0367-sv-struct-array.md) | ГОТОВО (сверка с отчётом пройдена) |
| 0368 | Элемент агрегата печатается по типу элемента | [0368-aggregate-element-type.md](0368-aggregate-element-type.md) | ГОТОВО (сверка с отчётом пройдена) |
| 0369 | Массив в параметре функции у цели sv | [0369-sv-array-parameter.md](0369-sv-array-parameter.md) | ГОТОВО (сверка с отчётом пройдена) |
| 0370 | Понижение q-литерала доходит до полей структуры | [0370-struct-field-fixed.md](0370-struct-field-fixed.md) | ГОТОВО (сверка с отчётом пройдена) |
| 0371 | Приведение q из поля структуры масштабируется | [0371-fixed-cast-from-field.md](0371-fixed-cast-from-field.md) | ГОТОВО (сверка с отчётом пройдена) |
| 0372 | Составной элемент массива в параметре функции | [0372-composite-array-parameter.md](0372-composite-array-parameter.md) | ГОТОВО (сверка с отчётом пройдена) |
| 0373 | Локальная переменная структурного типа у цели sv | [0373-sv-struct-local.md](0373-sv-struct-local.md) | ГОТОВО (сверка с отчётом пройдена) |
| 0374 | Приведение, совпадающее после отображения типа | [0374-mapped-type-cast.md](0374-mapped-type-cast.md) | ГОТОВО (сверка с отчётом пройдена) |
| 0375 | Частично использованная локальная структура у цели sv | [0375-sv-partial-struct-local.md](0375-sv-partial-struct-local.md) | ГОТОВО (сверка с отчётом пройдена) |
| 0376 | Неиспользуемая локальная переменная гасится заглушкой | [0376-unused-local-stub.md](0376-unused-local-stub.md) | ГОТОВО (сверка с отчётом пройдена) |
| 0377 | Артефакты сборки не попадают в репозиторий | [0377-build-artifacts-gate.md](0377-build-artifacts-gate.md) | ГОТОВО (сверка с отчётом пройдена) |
| 0378 | Имя переменной, совпавшее с именем типа, у цели st | [0378-st-name-type-clash.md](0378-st-name-type-clash.md) | ГОТОВО (сверка с отчётом пройдена) |
| 0379 | Сброс перечислимого регистра у цели sv | [0379-sv-enum-reset.md](0379-sv-enum-reset.md) | ГОТОВО (сверка с отчётом пройдена) |
| 0380 | Fixed-point в параметре функции | [0380-fixed-point-parameter.md](0380-fixed-point-parameter.md) | ГОТОВО (сверка с отчётом пройдена) |
| 0381 | Понижение q-литерала в телах и условиях | [0381-fixed-literal-in-body.md](0381-fixed-literal-in-body.md) | ГОТОВО (сверка с отчётом пройдена) |
| 0382 | Понижение q-литерала в поле структуры и элементе массива | [0382-fixed-literal-in-place.md](0382-fixed-literal-in-place.md) | ГОТОВО (сверка с отчётом пройдена) |
| 0383 | Приведение дробного литерала к q(m, n) в теле | [0383-fixed-cast-literal-in-body.md](0383-fixed-cast-literal-in-body.md) | ГОТОВО (сверка с отчётом пройдена) |
| 0384 | Приведение имени константы к q(m, n) | [0384-fixed-cast-const.md](0384-fixed-cast-const.md) | ГОТОВО (сверка с отчётом пройдена) |
| 0385 | Слово from — контекстное ключевое | [0385-contextual-from.md](0385-contextual-from.md) | ГОТОВО (сверка с отчётом пройдена) |
| 0386 | SE-036 видит локальные объявления тел | [0386-unused-local-warning.md](0386-unused-local-warning.md) | ГОТОВО (сверка с отчётом пройдена) |
| 0387 | Локальная переменная, записанная но не прочитанная | [0387-write-only-local.md](0387-write-only-local.md) | ГОТОВО (сверка с отчётом пройдена) |
| 0388 | Разделение печати объявлений цели st | [0388-st-decl-split.md](0388-st-decl-split.md) | ГОТОВО (сверка с отчётом пройдена) |
| 0389 | Массив в параметре функции цели rust — по ссылке | [0389-rust-array-by-reference.md](0389-rust-array-by-reference.md) | ГОТОВО (сверка с отчётом пройдена) |
