...
| Симулятор | двухрежимный эталон `float` | T7, T8, T9 | ✅ Q-режим (0096-02); native-режим — 0096-03 |
| Явный `q(m,n)` (0061) | **не задет** | T10 | ✅ (сверки 0061 зелены; гейт исходного типа) |
| Корпус | **не задет** без флагов | T1 | ✅ (0096-02) |
| Документация | режимы различны | T11 | ⬜ (0096-04) |
