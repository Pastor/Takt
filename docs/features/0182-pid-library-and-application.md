...
- **Related issues:** [Фича 0182](0182-pid-library-and-application.md); смежно с [ADR 0097](0097-pid-regulator-example.md#архитектура-adr) и [ADR 0096](0096-fixed-point-native-float.md#архитектура-adr)
...
- ⚠️ **anti-windup пишется условиями**: насыщающего оператора в языке нет. Если
  [0170](0170-fixed-point-saturation.md) будет закрыта, пример и
...
- **Смежные, но не зависимости:**
  ...
  - [0174](0174-rust-new-without-default.md) — пока не закрыта,
...
[0184](0184-imported-shared-variables.md) (Tier 1), 0182 переведена в
...
ловушки именования — в [0182-01](0182-pid-library-and-application.md#разработка).
...
3. **Насыщение** ([0170](0170-fixed-point-saturation.md)) при закрытии
