...
- **Related issues:** [Фича 0084](0084-address-map-qualified-key.md); латентный дефект ядра [0020](0020-port-address-decl.md#архитектура-adr), выявлен при [0043](0043-address-map-export.md#архитектура-adr); родственно [0079](0079-sim-composition-ports.md) (плоское пространство имён портов)
...
Фикс задевает `c-hal` — поэтому [0043](0043-address-map-export.md#архитектура-adr) плоский ключ
...
Закрыть латентный дефект ядра [0020](0020-port-address-decl.md):
...
Реализована **Option A** [ADR 0084](0084-address-map-qualified-key.md#архитектура-adr).
...
[ADR 0084](0084-address-map-qualified-key.md#архитектура-adr): `AddressResolution.map`
