...
- **Related issues:** [Фича 0035](0035-ltl-in-blocks.md); опирается на
  [фичу 0010](0010-verification-ltl.md) (`ГОТОВО`); пересекается с
  [фичей 0044](0044-sim-assert-invariant.md); наследует принцип
  «громкий отказ вместо тихого пропуска» из
  [ADR 0025](0025-simulator-expression-eval.md#архитектура-adr) и
  [ADR 0024](0024-lam-formatter.md#архитектура-adr)
...
[ADR 0035](0035-ltl-in-blocks.md#архитектура-adr) принял комбинацию: **разбор** там, где
...
> фичу [0024](0024-lam-formatter.md).
...
[0035-01](0035-ltl-in-blocks.md#разработка)…[0035-04](0035-ltl-in-blocks.md#разработка)):
