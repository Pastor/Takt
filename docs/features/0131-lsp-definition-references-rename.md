...
- **Related issues:** [Фича 0131](0131-lsp-definition-references-rename.md);
  опирается на [ADR 0056](0056-lsp-goto-exact-file.md#архитектура-adr) (индекс адресует пару
  `(file_no, offset)`), [ADR 0072](0072-lsp-initialization-options.md#архитектура-adr)
  (`searchPaths`), [ADR 0125](0125-intellij-takt-lsp-tooling.md#архитектура-adr) (rename в плагине
