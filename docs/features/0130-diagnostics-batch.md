...
- **Related issues:** [Фича 0130](0130-diagnostics-batch.md);
  опирается на [ADR 0053](0053-diagnostics-file-id.md#архитектура-adr) (реестр файлов, новый вход
  рядом со старым), [ADR 0048](0048-deterministic-codegen.md#архитектура-adr) (детерминированный
...
- Фикстуры — `takt-lang/tests/data/diagnostics0130/`:
  ...
  ошибок»).
- T7–T9 — задачи 0130-02 и 0130-03 (готовы, покрыты тем же файлом тестов).
