...
- **Related issues:** [Фича 0154](0154-intellij-server-rename.md);
  серверный `rename` и «полнота или отказ» — [ADR 0131](0131-lsp-definition-references-rename.md#архитектура-adr);
  кросс-файловый охват — [ADR 0153](0153-lsp-workspace-index.md#архитектура-adr);
  PSI плагина и нативный rename — [ADR 0067](0067-intellij-rename-psi-import.md#архитектура-adr);
  подключение LSP4IJ — [ADR 0038](0038-intellij-semantic-tokens.md#архитектура-adr);
  единый источник форм деклараций — [ADR 0125](0125-intellij-takt-lsp-tooling.md#архитектура-adr)
...
- **Зависит от:** нет **формально**; по существу опирается на закрытую
  [0153](0153-lsp-workspace-index.md). До неё серверный `rename`
...
[0154-01](0154-intellij-server-rename.md#разработка) ·
