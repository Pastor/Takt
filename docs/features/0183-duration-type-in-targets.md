...
- **Related issues:** [Фича 0183](0183-duration-type-in-targets.md);
  вскрыта при разработке [0143](0143-after-const-duration.md); смежно
  с [ADR 0134](0134-language-time-model.md#архитектура-adr) (модель времени),
...
[ADR 0183](0183-duration-type-in-targets.md#архитектура-adr): представление — целое без
...
- **Зависит от:** `нет` — все предпосылки закрыты:
  ...
  - фича [0143](0143-after-const-duration.md) закрыта; её ограничение
...
**Ключевое решение** ([ADR 0183](0183-duration-type-in-targets.md#архитектура-adr), Option A
