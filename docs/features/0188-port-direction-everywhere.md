...
- **Related issues:** [Фича 0188](0188-port-direction-everywhere.md); ось 3 [ADR 0187](0187-port-io-redesign.md#архитектура-adr); опирается на [0020](0020-port-address-decl.md#архитектура-adr)
...
[ADR 0188](0188-port-direction-everywhere.md#архитектура-adr) принял Option A:
...
- **Влияние на порядок:** это ось 3 проработки
  [0187](0187-port-io-redesign.md#анализ), выделенная в отдельную работу решением
