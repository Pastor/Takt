...
- **Related issues:** [Фича 0245](0245-sim-state-of-model.md); повод —
  [фича 0237](0237-book-state-of-model-section.md) (документирование
  конструкции); форма паттерна — [0203](0203-validate-formulas-traversal.md),
  перевод в цель `c` — [0075](0075-lib-src-reference-model.md).
...
что вынесен кандидатом [0217](0217-stub-branch-gate.md).
...
- Эталон исполняет конструкцию, которую переводит цель `c`; трасса и прошивка
  сверяемы потактово.
- Фича [0237](0237-book-state-of-model-section.md) получает
...
- **Влияние на порядок разработки:** фича **разблокирует**
  [0237](0237-book-state-of-model-section.md) — та документирует
...
[0237](0237-book-state-of-model-section.md) разблокирована и может
...
[задаче 0245-01](0245-sim-state-of-model.md#разработка).
