...
- **Related issues:** [Фича 0287](0287-wider-type-array-literal.md); смежные — [0204](0204-const-ref-type-inference.md) (вывод через ссылку, там кандидат и вынесен), [0285](0285-inferred-width-from-result.md) (ширина по результату), [0207](0207-bitwise-not-unsigned-literal.md) (нормирование вычисленного), [0192](0192-const-init-fold.md) (свёртка инициализатора)
...
[0285](0285-inferred-width-from-result.md) отвечает верно (`301`,
...
верно: [0285](0285-inferred-width-from-result.md) расширяет тип по
...
- **Влияние на порядок разработки:** не разблокирует ничего. Соседний класс —
  [0262](0262-wide-bit-vector-c-rust.md) (`[bit; N > 64]` у целей
...
Замер 2026-08-19 (таблица — в [анализе](0287-wider-type-array-literal.md#анализ)):
...
- **случай «результат не влезает в наибольшую ширину»** (`i8 + u8` со значением
  200) лечит существующее правило [0285](0285-inferred-width-from-result.md)
...
и переписана — разбор в [задаче 0287-01](0287-wider-type-array-literal.md#разработка).
