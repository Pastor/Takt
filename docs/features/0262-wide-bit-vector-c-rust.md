...
- **Related issues:** [Фича 0262](0262-wide-bit-vector-c-rust.md); смежные — [0078](0078-bit-array-semantics.md) (слой упаковки), [0250](0250-bit-write-in-targets.md) (где замер снят), [0045](0045-sv-backend.md) (цель `sv` тот же вход умеет)
...
- **Влияние на порядок разработки:** не разблокирует. Смежная запись
  [0293](0293-struct-in-st-rust.md) (структуры в `st`/`rust`) — иной
