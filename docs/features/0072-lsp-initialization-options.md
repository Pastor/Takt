...
- **Related issues:** [Фича 0072](0072-lsp-initialization-options.md); продолжает [0055](0055-lsp-multifile.md) (неявный путь = каталог документа), [0056](0056-lsp-goto-exact-file.md) (goto по путям).
...
- **Проверка:** 8 юнит-тестов разбора + 4 интеграционных (`lsp72_init_options`,
  ...
  [0072-01](0072-lsp-initialization-options.md#разработка).
