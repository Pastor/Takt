...
- **Related issues:** [Фича 0070](0070-port-initializer-address-role.md); опирается на модель адреса [ADR 0020](0020-port-address-decl.md#архитектура-adr); смежно [фикс 0020-01](../fixes/0020-01-port-bit-out-of-range.md)/[фича 0098](0098-port-bit-range-safe-hal.md) (диапазон бита); вскрыто при закрытой [0042](0042-address-defines.md)
...
- **Зависит от:** **нет.** Смежные (не блокирующие): [0020](0020-port-address-decl.md)
  (модель адреса — **закрыта**, её контракт мы опираем), [0098](0098-port-bit-range-safe-hal.md)
