...
**Сделано** (задача [0168-02](0168-generator-warnings-return.md#разработка)):
...
- **Date:** 2026-08-16
- **Authors:** Архитектор
- **Related issues:** [Фича 0168](0168-generator-warnings-return.md); дефект воспроизведён целью `sv` в [ADR 0064](0064-sv-divider-warning.md#архитектура-adr) (action A-6 — «чинить здесь нельзя, заведено кандидатом»); смежно с [ADR 0081](0081-lamc-print-warnings.md#архитектура-adr) (единая точка предупреждений компилятора), [фичей 0228](0228-compile-warning-position.md) (позиция предупреждения теряется при печати), задачей 0028-01 (копия формата диагностики разошлась)
...
[0228](0228-compile-warning-position.md): позиция в `loc` есть, а до
...
[0203](0203-validate-formulas-traversal.md)), но `site.loc` — это
...
- **Зависит от:** `нет`. Точка печати CLI (`compile_cli::print_warnings`) готова
  ...
  [0081](0081-lamc-print-warnings.md) и
  [0228](0228-compile-warning-position.md). Контракт
...
- **Влияние на порядок разработки:** ничего не разблокирует и ничем не
  ...
  [0212](0212-c-diagnostic-without-code.md) (диагностика цели `c`
...
[отчёт](0168-generator-warnings-return.md#отчёт-о-тестировании), задачи
[0168-01](0168-generator-warnings-return.md#разработка) и
[0168-02](0168-generator-warnings-return.md#разработка).
