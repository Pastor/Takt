...
- **Номер:** 0026
- **Статус:** **РАЗРАБОТКА** (ADR принят, анализ выполнен; подзадача
  [`0026-01`](../development/0026-01-c-root-typedef.md) готова к взятию в работу)
...
| Отчёт о тестировании | [`docs/reports/0026-c-root-typedef.md`](../reports/README.md) |
