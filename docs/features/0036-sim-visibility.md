...
([ADR 0036](0036-sim-visibility.md#архитектура-adr)) — **инкапсулировать `Unit`**:
...
- **Related issues:** [Фича 0036](0036-sim-visibility.md); опирается
  на правила [`docs/CODE.md`](../CODE.md) (приватные поля, Newtype,
  `#[non_exhaustive]`, запрет `deny(warnings)`) и их применение в фиче
  [0018](0018-code-guidelines.md) ([анализ](0018-code-guidelines.md#анализ);
  собственного ADR у 0018 нет); учитывает инвариант
  [ADR 0025](0025-simulator-expression-eval.md#архитектура-adr)
...
`private_interfaces` при каждой сборке. Решение ([ADR 0036](0036-sim-visibility.md#архитектура-adr),
Option B) — инкапсулировать `Unit` (`pub struct` + приватный `enum UnitKind`),
...
они в [0036-02](0036-sim-visibility.md#разработка).
...
1. **Ничто не удерживает крейт от рассогласования видимости.** В
   ...
   Убрать их разово (задача [0036-01](0036-sim-visibility.md#разработка)) недостаточно:
...
> [0036-01](0036-sim-visibility.md#разработка): включать `deny` до устранения утечек —
...
- **Фича:** [0036](0036-sim-visibility.md)
- **ADR:** [0036](0036-sim-visibility.md#архитектура-adr) · **Анализ:** [0036](0036-sim-visibility.md#анализ) · **Тест-план:** [0036](0036-sim-visibility.md#тест-план)
- **Задачи:** [0036-01](0036-sim-visibility.md#разработка) (инкапсуляция), [0036-02](0036-sim-visibility.md#разработка) (защёлка/версия)
- **Дата:** 2026-07-19
