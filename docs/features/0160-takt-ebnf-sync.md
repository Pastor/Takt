...
- **Related issues:** [Фича 0160](0160-takt-ebnf-sync.md); смежные — [ADR 0021](0021-swap-assign-compare.md#архитектура-adr) (реформа операторов), [фича 0116](0116-book-grammar.md) (приложение «Грамматика» книги), [ADR 0140](0140-backlog-revision-doc-split.md#архитектура-adr) (разделение ролей README и `book/`, правило 15), [ADR 0201](0201-dead-lexemes.md#архитектура-adr) (мёртвая лексика)
...
- приложение [`book/src/appendix-grammar/index.typ`](../../book/src/appendix-grammar/index.typ)
  (269 строк) — заведено фичей [0116](0116-book-grammar.md) и объявлено в
...
| P13 | `-->` в сводке пунктуации | есть | **есть** — терминал изъят фичей [0201](0201-dead-lexemes.md#архитектура-adr) |
...
- **Влияние на порядок разработки:** завершение не разблокирует ни одной фичи —
  ...
  далее идёт класс «семантика» ([0170](0170-fixed-point-saturation.md)).
...
| **P13** | `-->` из сводки пунктуации **изъять** | extern-блок грамматики | терминала нет с фичи [0201](0201-dead-lexemes.md) |
...
⚠️ **Оператор-выражение обязан иметь эффект** (фича [0189](0189-anonymous-ports.md),
...
| Задача | Содержание |
|---|---|
| [0160-01](0160-takt-ebnf-sync.md#разработка) | Приложение книги: правки P2, P4…P14 + дополнение `model_element`/`state_element` |
| [0160-02](0160-takt-ebnf-sync.md#разработка) | Гейт `scripts/check-book-keywords.py` + включение в `precheck.sh` + самопроверка |
| [0160-03](0160-takt-ebnf-sync.md#разработка) | Удаление `Takt.ebnf`, перенаправление ссылок README |
...
- в сводке пунктуации стоял `-->` (терминал изъят фичей
  [0201](0201-dead-lexemes.md)) и не было `=>` и `#`;
...
Гейт лексики задачи [0160-02](0160-takt-ebnf-sync.md#разработка) на исправленном
...
[0201](0201-dead-lexemes.md) (та же слепота у раздела
`book/src/02-lexical/`).
...
[0160-01](0160-takt-ebnf-sync.md#разработка) ·
[0160-02](0160-takt-ebnf-sync.md#разработка) ·
[0160-03](0160-takt-ebnf-sync.md#разработка) ·
