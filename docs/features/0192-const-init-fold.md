...
- **Related issues:** [Фича 0192](0192-const-init-fold.md); связь с
  [ADR 0187](0187-port-io-redesign.md#архитектура-adr) (тот же приём **уже применён к портам**),
  [ADR 0143](0143-after-const-duration.md#архитектура-adr) (константная выдержка сворачивается
  на семантике), [ADR 0185](0185-model-parameters.md#архитектура-adr) (общий константный
...
Фича [0187](0187-port-io-redesign.md) решила ровно эту задачу для
...
- Значенческие тесты — задача [0192-02](0192-const-init-fold.md#разработка).
...
обязан влезать в тип» ([0157](0157-literal-u64-representation.md)).
