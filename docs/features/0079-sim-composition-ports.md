...
- **Related issues:** [Фича 0079](0079-sim-composition-ports.md); выявлено при [0030](0030-comprehensive-example-fix.md#архитектура-adr); симптом `SIM-009` замаскирован [0086](0086-sim-var-without-initializer.md#архитектура-adr).
...
- **Фича:** [0079](0079-sim-composition-ports.md)
- **ADR:** [0079](0079-sim-composition-ports.md#архитектура-adr)
- **Дата:** 2026-07-20
- **Роль:** Аналитик

### Зависит от

Пусто. Смежна с [0084](0084-address-map-qualified-key.md) (плоское
...
- **Фича:** [0079](0079-sim-composition-ports.md)
- **ADR:** [0079](0079-sim-composition-ports.md#архитектура-adr)
- **Тест-план:** [0079](0079-sim-composition-ports.md#тест-план)
- **Дата:** 2026-07-20
- **Вердикт:** ✅ **ГОТОВО**
