...
- **Related issues:** [Фича 0027](0027-module-size-split.md); по духу
  продолжает фичу-рефакторинг
  [0018](0018-code-guidelines.md) («Приведение кода к требованиям
...
([ADR 0027](0027-module-size-split.md#архитектура-adr), Option A).
...
| «Оформить по образцу 0018» | У фичи 0018 **нет ADR** (`docs/adr/0018-*` не существует) — стадия 2 тогда не оформлялась. Образцом ADR взят [0024](0024-lam-formatter.md#архитектура-adr), образцом карточки/анализа — 0018 | ⚠️ уточнено |
...
>
> **Предусловие:** выполнена [0027-01](0027-module-size-split.md#разработка) (есть
...
>
> **Предусловие:** выполнена [0027-01](0027-module-size-split.md#разработка) и снят
