...
- **Related issues:** [Фича 0176](0176-bit-port-address-position.md); продолжение
  [ADR 0070](0070-port-initializer-address-role.md#архитектура-adr) (инициализатор порта — адрес), смежно
  [0098](0098-port-bit-range-safe-hal.md#архитектура-adr) (диапазон бита, ширина доступа HAL) и
  [0020](0020-port-address-decl.md#архитектура-adr) (три источника адреса)

### Context

[ADR 0070](0070-port-initializer-address-role.md#архитектура-adr) снял с портов проверку значения
...
[ADR 0176](0176-bit-port-address-position.md#архитектура-adr) принял (решение заказчика
