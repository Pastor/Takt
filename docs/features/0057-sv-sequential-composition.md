...
- **Зависит от:** 0045 (SV-бэкенд, закрыта) — её [ADR](0045-sv-backend.md#архитектура-adr) уже принял отображение `+` (Option A′), задача 0045-06 оставила его как `SV-002`
...
- **Related issues:** [Фича 0057](0057-sv-sequential-composition.md); опирается на [ADR 0045](0045-sv-backend.md#архитектура-adr) (вопрос 3, часть 2 — Option A′), контракт [ADR 0033](0033-init-tick-alignment.md#архитектура-adr) (вход в стартовое состояние не расходует такт)
