...
- **Related issues:** [Фича 0177](0177-features-registry-status-gate.md);
  смежные — [0164](0164-registry-rebuild-gate.md) (реестры против
  диска), [ADR 0149](0149-claude-md-consistency-gate.md#архитектура-adr) и
  [ADR 0146](0146-book-glyph-gate.md#архитектура-adr) (тот же приём: правило + машинная проверка)
...
Фича [0138](0138-coverage-measurement.md) закрыта полным циклом —
...
1. **Существование в обе стороны** — у строки реестра есть карточка, у карточки
   ...
   реестров с диском — предмет [0164](0164-registry-rebuild-gate.md),
...
[0099](0099-module-size-core.md) и описана в `FEATURES.md`, но в свод
...
- **A-3. Область не расширена до прочих реестров** (`docs/features/README.md` и др.) —
  это [0164](0164-registry-rebuild-gate.md). Гейт 0177 уже считает
...
[0138](0138-coverage-measurement.md) закрыта **полным циклом**: ADR,
...
**`ЗАМОРОЖЕНА`** (фича [0099](0099-module-size-core.md), решение
...
Карточка допускала объединение с [0164](0164-registry-rebuild-gate.md)
...
|---|---|
| [`0177-01`](0177-features-registry-status-gate.md#разработка) | Гейт `check-feature-status.py`, подключение к предкоммиту, правка строки 0138 |
...
Карточка допускала слияние с [0164](0164-registry-rebuild-gate.md).
