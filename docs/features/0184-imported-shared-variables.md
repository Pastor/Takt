...
- **Related issues:** [Фича 0184](0184-imported-shared-variables.md); вскрыто пробами стадии разработки [0182](0182-pid-library-and-application.md); механизм импорта — [ADR 0055](0055-lsp-multifile.md#архитектура-adr), правило доступа цели `c` — [ADR 0026](0026-c-root-typedef.md#архитектура-adr)
...
(засада, зафиксированная ещё [ADR 0096](0096-fixed-point-native-float.md#архитектура-adr)), и
...
3. **Переиспользование — заявленная возможность языка.** Раздел документа обещает
   ...
   [0182](0182-pid-library-and-application.md) нереализуема.
...
- **Влияние на порядок разработки:** **разблокирует**
  [0182](0182-pid-library-and-application.md) (библиотечный ПИД и
...
Проверки R3/R4 — в задаче [0184-02](0184-imported-shared-variables.md#разработка).
...
5. **Разблокирована [0182](0182-pid-library-and-application.md)** —
