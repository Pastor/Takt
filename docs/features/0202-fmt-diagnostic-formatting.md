...
⚠️ Раздел [`book/src/16-diagnostics/`](../../book/src/16-diagnostics/index.typ)
...
- **Date:** 2026-08-04
- **Authors:** Архитектор
- **Related issues:** [Фича 0202](0202-fmt-diagnostic-formatting.md); смежные — [ADR 0053](0053-diagnostics-file-id.md#архитектура-adr) (формат позиции — свойство диагностики, а не бинарника), [ADR 0028](0028-c-generator-stubs.md#архитектура-adr) (копия формата в `taktc` уже расходилась), [фича 0168](0168-generator-warnings-return.md) (библиотека печатает диагностику сама — тот же принцип, другой канал)
...
- **Влияние на порядок разработки:** ничего не блокирует.
  [0168](0168-generator-warnings-return.md) исповедует тот же
...
[отчёт](0202-fmt-diagnostic-formatting.md#отчёт-о-тестировании), задача
[`0202-01`](0202-fmt-diagnostic-formatting.md#разработка). Исправлений
