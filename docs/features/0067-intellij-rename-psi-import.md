...
(гибрид Option C из [ADR 0040](0040-intellij-psi-parser.md#архитектура-adr)).
...
- **Related issues:** [Фича 0067](0067-intellij-rename-psi-import.md);
  прямое продолжение [ADR 0040](0040-intellij-psi-parser.md#архитектура-adr) (гибрид Option C —
  тонкий структурный PSI + LSP4IJ) в части его контрольной точки «после закрытия
  0038»; опирается на [ADR 0023](0023-intellij-navigation-include.md#архитектура-adr) (плоский
  `LamParser`, навигация), [ADR 0022](0022-intellij-syntax-highlight.md#архитектура-adr) (лексер,
  автономность) и закрытую фичу [0038](0038-intellij-semantic-tokens.md)
  (LSP4IJ вживую).
...
заданы [ADR 0067](0067-intellij-rename-psi-import.md#архитектура-adr) (Option B —
...
- **[ADR 0067](0067-intellij-rename-psi-import.md#архитектура-adr) — Option B
