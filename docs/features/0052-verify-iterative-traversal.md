...
- **Related issues:** [Фича 0052](0052-verify-iterative-traversal.md);
  вырос из открытого вопроса 3 стадии тестирования [фичи 0049](0049-model-checking-ltl.md#архитектура-adr)
...
| Задача | Содержание |
|---|---|
| [0052-01](0052-verify-iterative-traversal.md#разработка) | `minimap::visit_state` → итеративный (чинит все 5 целей) |
| [0052-02](0052-verify-iterative-traversal.md#разработка) | nested-DFS (`check.rs`) → итеративный |
...
**Почему не список задач, как в [0052-01](0052-verify-iterative-traversal.md#разработка).** Оба
...
- **Виновник — один на все цели** (задача
  [0052-01](0052-verify-iterative-traversal.md#разработка)):
...
- **nested-DFS — сложнее и без срочности** (задача
  [0052-02](0052-verify-iterative-traversal.md#разработка)): `outer_dfs` делает
