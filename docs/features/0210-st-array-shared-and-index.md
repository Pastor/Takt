...
[0186-01](0186-book-processor-example.md#разработка) (2026-07-30).
...
- **Date:** 2026-08-16
- **Authors:** Архитектор
- **Related issues:** [Фича 0210](0210-st-array-shared-and-index.md); находка задачи [0186-01](0186-book-processor-example.md#разработка); класс «цель рапортует об успехе при негодном выводе» — [ADR 0184](0184-imported-shared-variables.md#архитектура-adr); ловушки MatIEC — [ADR 0041](0041-st-backend.md#архитектура-adr)
...
[0184](0184-imported-shared-variables.md#архитектура-adr): цель принимает вход и порождает
...
- **Зависит от:** `нет`. Ядро цели `st` (фича
  [0041](0041-st-backend.md)) и слой `bit_vector` (фича
  [0078](0078-bit-array-semantics.md)) закрыты; гейт `iec2c` работает.
...
[0212](0212-c-diagnostic-without-code.md)). Это положение дел **до**
...
[отчёт](0210-st-array-shared-and-index.md#отчёт-о-тестировании), задача
[0210-01](0210-st-array-shared-and-index.md#разработка).
