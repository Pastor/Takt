...
- **Related issues:** [Фича 0053](0053-diagnostics-file-id.md);
  вырос из action item A1 [ADR 0051](0051-verify-scope.md#архитектура-adr)
...
| Задача | Содержание |
|---|---|
| [0053-01](0053-diagnostics-file-id.md#разработка) | `FileTable`, `Diagnostic::file`, настоящий `file_no` в трёх формах импорта |
| [0053-02](0053-diagnostics-file-id.md#разработка) | Разрешение пути в `compile_to_*` и печать `путь:строка:колонка` в `lamc` |
...
- **Реестр `FileTable` не выходит в публичный API** (задача
  [0053-01](0053-diagnostics-file-id.md#разработка)): он — деталь компиляции,
...
- **Семикратное дублирование ушло** (задача
  [0053-02](0053-diagnostics-file-id.md#разработка)): пара «`parse` +
