...
- **Related issues:** [Фича 0132](0132-sim-named-port-scenarios.md);
  опирается на [ADR 0135](0135-sim-qualified-port-names.md#архитектура-adr) (квалифицированное
  имя `Модель::порт`), [ADR 0079](0079-sim-composition-ports.md#архитектура-adr) (порты
