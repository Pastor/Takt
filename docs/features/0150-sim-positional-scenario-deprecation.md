...
- **Related issues:** [Фича 0150](0150-sim-positional-scenario-deprecation.md);
  именованная форма и `SIM-032` — [ADR 0132](0132-sim-named-port-scenarios.md#архитектура-adr);
  квалифицированные имена портов — [ADR 0135](0135-sim-qualified-port-names.md#архитектура-adr);
  «пропущенный гейт зелёный, то есть неотличим от пройденного» —
  [ADR 0090](0090-ci-precheck.md#архитектура-adr)
...
[0150-01](0150-sim-positional-scenario-deprecation.md#разработка) ·
