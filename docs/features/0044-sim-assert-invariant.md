...
- **Related issues:** [Фича 0044](0044-sim-assert-invariant.md); связь с
  [ADR 0024](0024-lam-formatter.md#архитектура-adr) (печать нового узла АСД обязательна),
  [ADR 0025](0025-simulator-expression-eval.md#архитектура-adr) (семантика вычислений живёт в
  `simulation/src/eval/`; ошибка обязана быть отличима от «условие ложно»),
  [ADR 0019](0019-condition-expression-unification.md#архитектура-adr) (разделение
  `Condition`/`Expression` — намеренное), [ADR 0020](0020-port-address-decl.md#архитектура-adr)
  (образец введения жёсткого ключевого слова `address`); фича
  [0010](0010-verification-ltl.md) (LTL/Бюхи, `ГОТОВО`); фича
  [0035](0035-ltl-in-blocks.md) (LTL в блоках кода, `СОЗДАНА`).
...
[0044-01](0044-sim-assert-invariant.md#разработка)…[0044-06](0044-sim-assert-invariant.md#разработка)):
