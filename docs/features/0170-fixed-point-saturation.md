...
- **Related issues:** [Фича 0170](0170-fixed-point-saturation.md); смежные — [ADR 0061](0061-fixed-point-type.md#архитектура-adr) (тип `q(m, n)`, правило 3 — wraparound), фикс [0061-01](../fixes/0061-01-q-wrap-storage-width.md) (перенос к `W`), [ADR 0127](0127-int-overflow-semantics.md#архитектура-adr) (семантика переполнения целых), [фича 0096](0096-fixed-point-native-float.md) (прозрачный `float` через `--float-as-q`)
...
- **Зависит от:** нет **незакрытых**. Проверено: ядро [0061](0061-fixed-point-type.md)
...
| Задача | Содержание |
|---|---|
| [0170-01](0170-fixed-point-saturation.md#разработка) | Синтаксис и семантика: `Type::Fixed` + признак, `construct_fixed` (`SE-104`), `TypeNode::Fixed { sat }`, равенство типов, `SE-103` при смешении; форматтер и слой использований |
| [0170-02](0170-fixed-point-saturation.md#разработка) | Эталон: `Value::Fixed { sat }`, `sat_to` в `eval/fixed.rs`, все операции R4 |
| [0170-03](0170-fixed-point-saturation.md#разработка) | Цели `c` и `rust` |
| [0170-04](0170-fixed-point-saturation.md#разработка) | Цели `st` и `sv` |
| [0170-05](0170-fixed-point-saturation.md#разработка) | Сверки значений (четыре цели), версия языка, документ `book/` |
...
После задачи [0170-01](0170-fixed-point-saturation.md#разработка) тип нёс признак, но
...
Эталон ([0170-02](0170-fixed-point-saturation.md#разработка)) насыщает, цели — нет:
...
verdict даёт только сверка значений — её заводит [0170-05](0170-fixed-point-saturation.md#разработка).
Цели `st` и `sv` вводит [0170-04](0170-fixed-point-saturation.md#разработка).

### Задача 0170-04

#### Что было

После [0170-03](0170-fixed-point-saturation.md#разработка) насыщали эталон, `c` и `rust`;
...
Вердикт даёт сверка значений: задача [0170-05](0170-fixed-point-saturation.md#разработка).

### Задача 0170-05

#### Что было

После задач [0170-02](0170-fixed-point-saturation.md#разработка)…[0170-04](0170-fixed-point-saturation.md#разработка)
...
[0157](0157-literal-u64-representation.md): её ADR и первая редакция
...
[0205](0205-as-in-declaration-initializer.md). Документ показывает
...
[0157](0157-literal-u64-representation.md) — совпадение не
...
в [0170-01](0170-fixed-point-saturation.md#разработка).
