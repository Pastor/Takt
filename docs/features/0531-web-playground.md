...
`0531-06`, `0531-07a`, `0531-07b`, `0531-09a`, `0531-09b` и `0531-10a` (разделы
...
| 12 | `0531-09g` | **скачивание проекта архивом** (поручение заказчика 2026-09-04): без генерации либо вместе с порождёнными исходниками целей. ⚠️ Перед началом требует решения: **где собирается архив** — см. ниже | 09b | по итогам решения |
