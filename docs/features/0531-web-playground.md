...
**Варианты значков предложены прогоном.** Три набора отрисованы на живом
`app.css` и сняты на экран: A — контур (то, что выложено), B — техника
(геометрия, сетка), C — заливка. У набора B нашлось своё: «Сохранить» и
«Скачать архивом» в нём оба стрелка вниз и в шапке неразличимы.
