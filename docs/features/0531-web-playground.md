...
**Комментарий подсветки стал нейтрально серым** (просьба заказчика
2026-09-05). ⚠️ Дело было не в контрасте: у оливкового `#61684F` он к полю
ввода 4.88 — «сливается» тут значит «того же тона, что палитра страницы», а
она зеленоватая. Нейтральный `#6F706E` держит те же 4.88 к фону и разводит
комментарий с чернилами (2.22 → 2.60). Тёмная тема получила свой нейтральный
взамен синеватого.
...
| контрол описан в книге и показан на витрине | `check-design.py`, правило D6 |
