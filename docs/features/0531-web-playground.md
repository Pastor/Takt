...
и порядок их выполнения — в разделе «Анализ»); идёт разработка — задачи
`0531-01` и `0531-02` выполнены (раздел «Разработка»). Ниже — то, что сказал заказчик,
...
- **Проработка поручена модели Fable** (решение заказчика 2026-09-04); её итог
  вносится в этот подраздел и превращается в требования.
- **Что проработка обязана ответить:** кеширование статики и модуля на стороне
