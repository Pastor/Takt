...
- **Related issues:** [Фича 0078](0078-bit-array-semantics.md); смежна [0076](0076-sim-arrays.md) (настоящие массивы `[T;N]`), [0029](0029-c-type-mapping.md) (отображение типов C), [0061](0061-fixed-point-type.md)/[0060](0060-enum-width-shared-layer.md) (образец «единый слой на все цели»).
...
— упакованный N-битный вектор в родных типах цели (решение заказчика, [ADR 0078](0078-bit-array-semantics.md#архитектура-adr),
...
- **Зависит от:** `нет` (использует существующие механизмы). Смежна
  [0076](0076-sim-arrays.md) (настоящие массивы `[T;N]` — дискриминатор
  «элемент == bit» отделяет бит-вектор от них), продолжает
  [0029](0029-c-type-mapping.md). Образец единого слоя —
  [0060](0060-enum-width-shared-layer.md) (`enum_facts`).
...
Реализация по [ADR 0078](0078-bit-array-semantics.md#архитектура-adr) (Option A) — `[bit;N]`
...
Реализовано по [ADR 0078](0078-bit-array-semantics.md#архитектура-adr) (Option A, решение
