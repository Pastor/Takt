...
| Стадия | Артефакт |
|---|---|
| Архитектура (ADR) | [`docs/adr/0393-every-on-self-transition.md`](../adr/0393-every-on-self-transition.md) |
| Анализ | [`docs/analyze/0393-every-on-self-transition.md`](../analyze/0393-every-on-self-transition.md) |
