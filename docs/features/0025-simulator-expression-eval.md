...
- **Номер:** 0025
- **Статус:** РАЗРАБОТКА (`0025-01`, `0025-02a`, `0025-03` выполнены; `0025-02b`,
  `0025-04`, `0025-05` — нет). **Закрыты Д1, Д2, Д6, Д7, Д8 и обе паники**;
  второго вычислителя больше не существует. Остаются: Д3 и вычисление вызовов
  функций (`0025-02b` — интерпретатор операторов), Д5 (`enter` старта — `04`),
  R5 — отличимость ошибки от лжи (канал диагностики — `05`)
...
| Разработка | [`0025-01`](../development/0025-01-eval-core.md) ядро `eval` · [`0025-02a`](../development/0025-02a-expression-adapter.md) адаптер выражений · [`0025-03`](../development/0025-03-condition-adapter.md) адаптер условий — **выполнены**; `0025-02b` (интерпретатор операторов), `0025-04`, `0025-05` не начаты |
