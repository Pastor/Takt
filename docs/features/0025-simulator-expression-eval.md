...
- **Номер:** 0025
- **Статус:** РАЗРАБОТКА (`0025-01`, `0025-03` выполнены; `0025-02`, `0025-04`,
  `0025-05` — нет). **Закрыты Д6, Д7, Д8 и обе паники**; условия вычисляются верно.
  Остаются: Д1–Д3 (тела блоков — задача 02), Д5 (`enter` старта — 04), вычисление
  вызовов функций (02) и отличимость ошибки от лжи, R5 (канал диагностики — 05)
...
| Разработка | [`0025-01`](../development/0025-01-eval-core.md) — ядро `eval` (**выполнено**) · [`0025-03`](../development/0025-03-condition-adapter.md) — адаптер условий (**выполнено**) · `0025-02`, `0025-04`, `0025-05` не начаты |
