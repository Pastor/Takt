...
- **Номер:** 0025
- **Статус:** РАЗРАБОТКА (`0025-01`, `0025-02a`, `0025-02b-1`, `0025-03`
  выполнены; `0025-02b-2`, `0025-04`, `0025-05` — нет). **Закрыты Д1, Д2, Д6, Д7,
  Д8 и обе паники**; второго вычислителя нет, операторы (`var`, `while`, `for`,
  `match`) исполняются. Остаются: Д3, Д4 и поток управления (`0025-02b-2` —
  вызовы `fn`), Д5 (`enter` старта — `04`), R5 — отличимость ошибки от лжи
  (канал диагностики — `05`)
...
| Разработка | [`0025-01`](../development/0025-01-eval-core.md) ядро `eval` · [`0025-02a`](../development/0025-02a-expression-adapter.md) адаптер выражений · [`0025-02b-1`](../development/0025-02b-1-statement-interpreter.md) интерпретатор операторов · [`0025-03`](../development/0025-03-condition-adapter.md) адаптер условий — **выполнены**; `0025-02b-2` (поток управления + вызовы `fn`), `0025-04`, `0025-05` не начаты |
