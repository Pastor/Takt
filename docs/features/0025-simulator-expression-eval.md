...
- **Статус:** ТЕСТИРОВАНИЕ — реализация (`0025-01`…`0025-05`) завершена, отчёт
  ...
  (1584 теста). Остаются `0025-07` (автосверка с `lamc -t c`, критерий A8) и
  `0025-08` (перенос примеров в `README.md`, правила 15, 16); до них фича в
  `ГОТОВО` не переводится
