...
- **Номер:** 0025
- **Статус:** ТЕСТИРОВАНИЕ — **вся реализация завершена** (`0025-01`, `0025-02a`,
  `0025-02b-1`, `0025-02b-2`, `0025-03`, `0025-04`, `0025-05`). Все восемь дефектов
  Д1–Д8 закрыты, обе паники устранены, требования R1–R10 выполнены, критерии A6 (в
  исправленной формулировке) и A7 (`eta=7`) достигнуты. Следующий шаг — стадия 6,
