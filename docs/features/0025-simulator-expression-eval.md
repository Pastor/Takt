...
- **Номер:** 0025
- **Статус:** РАЗРАБОТКА (тест-план готов; `0025-01` выполнена, `0025-02…05` — нет.
  Симулятор **всё ещё** дефектен: ядро не подключено, Д1–Д8 воспроизводятся)
...
| Разработка | [`0025-01`](../development/0025-01-eval-core.md) — **ядро `eval` выполнено**; `0025-02…05` не начаты |
