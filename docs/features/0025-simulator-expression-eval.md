...
| Отчёт о тестировании | [`docs/reports/0025-simulator-expression-eval.md`](../reports/0025-simulator-expression-eval.md) — вердикт **✅ ПРОЙДЕН** (пересмотрен после доработки) |
...
паники устранены, требования R1–R10 выполнены. Отчёт: [вердикт ✅ ПРОЙДЕН](../reports/0025-simulator-expression-eval.md).

### Что изменилось в крейте `simulation`

Реализован [ADR 0025](../adr/0025-simulator-expression-eval.md), Option B: вместо
