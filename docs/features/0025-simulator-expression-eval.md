...
- **Статус:** РАЗРАБОТКА (`0025-01`, `0025-02a`, `0025-02b-1`, `0025-02b-2`,
  `0025-03` выполнены; `0025-04`, `0025-05` — нет). **Закрыты Д1–Д4 и Д6–Д8, обе
  паники устранены**; критерий A7 достигнут (`eta=7` у `stacker.lam`). Остаются:
  **Д5** (`enter` стартового состояния — задача `04`) и **R5** — отличимость
  ошибки от лжи (канал диагностики — задача `05`)
