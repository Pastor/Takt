...
- **Номер:** 0025
- **Статус:** РАЗРАБОТКА (`0025-01`, `0025-02a`, `0025-02b-1`, `0025-02b-2`,
  `0025-03`, `0025-04` выполнены; остаётся `0025-05`). **Все восемь дефектов
  Д1–Д8 закрыты**, обе паники устранены, критерии A6 (в исправленной формулировке)
  и A7 (`eta=7`) достигнуты. Остаётся **R5** — отличимость ошибки вычисления от
  честно ложного условия (канал диагностики, задача `05`)
