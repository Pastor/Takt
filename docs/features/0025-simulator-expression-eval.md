...
- **Номер:** 0025
- **Статус:** ТЕСТИРОВАНИЕ — реализация (`0025-01`…`0025-05`) завершена, отчёт
  (стадия 6) готов, **вердикт: НА ДОРАБОТКУ**. Все восемь дефектов Д1–Д8 закрыты,
  требования R1–R10 выполнены, регресса нет (1571 тест, сценарии 5 из 5), но не
  выполнены все пункты **собственного тест-плана**. **`0025-06` выполнена** —
  фикстуры и интеграционный слой заведены, проверка стала **воспроизводимой**
  (1584 теста). **`0025-07` выполнена** — сверка с
  `lamc -t c` автоматизирована (критерий A8). Остаётся `0025-08` (перенос
  примеров в `README.md`, правила 15, 16); до неё фича в `ГОТОВО` не переводится
...
| Разработка | [`0025-01`](../development/0025-01-eval-core.md) ядро `eval` · [`0025-02a`](../development/0025-02a-expression-adapter.md) адаптер выражений · [`0025-02b-1`](../development/0025-02b-1-statement-interpreter.md) интерпретатор операторов · [`0025-02b-2`](../development/0025-02b-2-function-calls.md) поток управления и вызовы `fn` · [`0025-03`](../development/0025-03-condition-adapter.md) адаптер условий · [`0025-04`](../development/0025-04-initial-enter.md) `enter` стартового состояния · [`0025-05`](../development/0025-05-diagnostic-channel.md) канал диагностики · [`0025-06`](../development/0025-06-fixtures-integration-tests.md) фикстуры и интеграционный слой · [`0025-07`](../development/0025-07-c-conformance-test.md) автосверка с C — **выполнены**; остаётся `0025-08` |
...
| Отчёт о тестировании | [`docs/reports/0025-simulator-expression-eval.md`](../reports/0025-simulator-expression-eval.md) — **готов**; вердикт **НА ДОРАБОТКУ** (`0025-06`…`0025-08`) |
