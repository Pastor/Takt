...
- **Связанные issue (анализ):** кандидаты блока 2 `FEATURES.md` (вскрыты пробами
  задачи [0187-05](0187-port-io-redesign.md#разработка) и
  [0157-05](0157-literal-u64-representation.md#разработка)); смежно с
...
- **Related issues:** [Фича 0191](0191-st-per-tick-conformance.md);
  связь с [ADR 0033](0033-init-tick-alignment.md#архитектура-adr) (вход в стартовое состояние не
  расходует такт), [ADR 0041](0041-st-backend.md#архитектура-adr) (бэкенд ST),
  [ADR 0078](0078-bit-array-semantics.md#архитектура-adr) (`[bit;N]` — упакованный скаляр)
...
[0033](0033-init-tick-alignment.md) устранила в цели `c` и объявила
...
[0078](0078-bit-array-semantics.md#архитектура-adr) массивом **не является**: это упакованный
...
[0183](0183-duration-type-in-targets.md).
...
- **Дифф корпуса `examples/generated/st`** — просмотреть поштучно; генерация
  детерминирована ([0048](0048-deterministic-codegen.md#архитектура-adr)), поэтому дифф несёт
  смысл.
...
[0183](0183-duration-type-in-targets.md) (потактовые сверки `st` и
...
фичи [0033](0033-init-tick-alignment.md) — «вход в стартовое
...
- Поведение доказывает задача [0191-02](0191-st-per-tick-conformance.md#разработка):
...
[0078](0078-bit-array-semantics.md) массивом **не является**: это
...
[0191-02](0191-st-per-tick-conformance.md#разработка) переходит по условию
...
переполнения. Фича [0127](0127-int-overflow-semantics.md) наткнулась
...
остаток [0183](0183-duration-type-in-targets.md) сохраняется и
