...
- **Related issues:** [Фича 0146](0146-book-glyph-gate.md);
  повод — [фикс 0132-01](../fixes/0132-01-book-glyph-outside-font.md); смежное —
  [ADR 0133](0133-book-examples-gate.md#архитектура-adr) (гейт примеров документа),
  [ADR 0179](0179-repo-url-cleanup.md#архитектура-adr) (граница «согласованность, а не правильность»)
...
- гейт [0133](0133-book-examples-gate.md#архитектура-adr) проверяет **примеры** документа
...
- **A-1. Гейт проверяет согласованность со снимком, а не с установленным
  шрифтом** (та же граница, что у [ADR 0179](0179-repo-url-cleanup.md#архитектура-adr)). Если на
...
- **Зависит от:** нет.
- **Смежные:** [0133](0133-book-examples-gate.md) — гейт **поведения**
...
|---|---|
| [`0146-01`](0146-book-glyph-gate.md#разработка) | Съёмщик снимка + снимок cmap Fira Code |
| [`0146-02`](0146-book-glyph-gate.md#разработка) | Гейт `check-book-glyphs.py` с самопроверкой, подключение к `precheck.sh` |
...
входит, а гейт [0133](0133-book-examples-gate.md#архитектура-adr) проверяет **поведение**
