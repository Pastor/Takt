...
- **Related issues:** [Фича 0251](0251-cargo-target-dir.md);
  каталог гейта и его самоочистка — [ADR 0234](0234-precheck-time-profile.md#архитектура-adr);
  профиль предкоммита и «замер верен только на устоявшейся ФС» —
  [ADR 0242](0242-grammar-crate-split.md#архитектура-adr);
  пути гейта берутся из каталога гейта — [ADR 0241](0241-precheck-speedup.md#архитектура-adr)
...
[0251-01](0251-cargo-target-dir.md#разработка) ·
