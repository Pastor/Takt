...
- **Related issues:** [Фича 0196](0196-editor-type-highlighting.md);
  связь с [ADR 0038](0038-intellij-semantic-tokens.md#архитектура-adr) (семантические токены),
  [ADR 0022](0022-intellij-syntax-highlight.md#архитектура-adr) (палитра плагина)
...
получал дважды: ADR [0056](0056-lsp-goto-exact-file.md#архитектура-adr) («позиция использования —
свойство ссылки») и фича [0131](0131-lsp-definition-references-rename.md)
...
узел `ast::Type`. Смежная [0153](0153-lsp-workspace-index.md)
...
2. **Второй обход АСД не понадобился.** Анализ предполагал новый модуль
   ...
   [0196-01](0196-editor-type-highlighting.md#разработка) с обоснованием:
...
[задача 0196-01](0196-editor-type-highlighting.md#разработка),
