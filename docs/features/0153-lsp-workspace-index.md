...
- **Related issues:** [Фича 0153](0153-lsp-workspace-index.md);
  слой использований и «полнота или отказ» — [ADR 0131](0131-lsp-definition-references-rename.md#архитектура-adr);
  адресация `(file_no, offset)` — [ADR 0056](0056-lsp-goto-exact-file.md#архитектура-adr);
  пути поиска из `initializationOptions` — [ADR 0072](0072-lsp-initialization-options.md#архитектура-adr);
  каталог импортёра как неявный путь — [ADR 0055](0055-lsp-multifile.md#архитектура-adr);
  усыновление импортированных объявлений — [ADR 0184](0184-imported-shared-variables.md#архитектура-adr)
...
- **Влияние на порядок разработки:** закрытие 0153 **разблокирует по существу**
  ...
  [0154](0154-intellij-server-rename.md) — перевод плагина IntelliJ
...
3. **Порядок разработки стоит пересмотреть** (правило 19): закрытие 0153 по
   существу разблокировало [0154](0154-intellij-server-rename.md) —
...
[0153-01](0153-lsp-workspace-index.md#разработка) ·
[0153-02](0153-lsp-workspace-index.md#разработка) ·
[0153-03](0153-lsp-workspace-index.md#разработка) ·
