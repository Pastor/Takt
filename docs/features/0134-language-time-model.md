...
- **Номер:** 0134
- **Статус:** РАЗРАБОТКА (0134-01…05 сделаны + выдержка в тактах `after Nt` +
  контракт частоты `--tick-hz`/`SE-069`/`SE-070` с CLI-частью 0134-08; далее —
  0134-04b (профиль «часы» в `c`), цели `rust`/`st`/`sv`, `0134-09` (`every`))
...
| Разработка | [`0134-01`](../development/0134-01-lexis-grammar-ast.md), [`0134-02`](../development/0134-02-type-and-lowering.md), [`0134-03`](../development/0134-03-simulator-clock.md), [`0134-04`](../development/0134-04-target-c.md), [`0134-05`](../development/0134-05-clock-contract.md) (контракт частоты + CLI 0134-08) — сделаны; `0134-04b` (профиль «часы» в `c`), цели `rust`/`st`/`sv`, `0134-09` (`every`) — впереди |
