...
- **Номер:** 0134
- **Статус:** РАЗРАБОТКА (0134-01…05 + 0134-04b сделаны: синтаксис, тип, симулятор,
  цель `c`/`c-hal` в **обоих** профилях, выдержка `after Nt`, контракт частоты
  `--tick-hz`/`SE-069`/`SE-070` с CLI-частью 0134-08; далее — цели `rust`/`st`/`sv`,
  `0134-09` (`every`))
