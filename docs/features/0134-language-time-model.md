...
- **Номер:** 0134
- **Статус:** РАЗРАБОТКА (0134-01…04 сделаны + выдержка в тактах `after Nt`;
  далее — [`0134-05`](../development/0134-05-clock-contract.md) «частота как
  контракт сборки» вместе с CLI-частью 0134-08, затем 0134-04b)
...
| Разработка | [`0134-01`](../development/0134-01-lexis-grammar-ast.md), [`0134-02`](../development/0134-02-type-and-lowering.md), [`0134-03`](../development/0134-03-simulator-clock.md), [`0134-04`](../development/0134-04-target-c.md) — сделаны; `0134-04b` (профиль «часы» в `c`), `0134-05…08`, `0134-09` (`every`) — впереди |
