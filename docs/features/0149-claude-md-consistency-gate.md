...
- **Related issues:** [Фича 0149](0149-claude-md-consistency-gate.md);
  смежные — [ADR 0085](0085-language-version-constant.md#архитектура-adr) (гейт версии языка),
  [ADR 0179](0179-repo-url-cleanup.md#архитектура-adr) и [ADR 0146](0146-book-glyph-gate.md#архитектура-adr)
...
- **Зависит от:** нет.
- **Смежные:** [0085](0085-language-version-constant.md) — гейт версии
  языка, расширяемый третьим источником; [0164](0164-registry-rebuild-gate.md)
...
|---|---|
| [`0149-01`](0149-claude-md-consistency-gate.md#разработка) | Гейт `check-claude-md.py` + третий источник версии языка + подключение к предкоммиту |
| [`0149-02`](0149-claude-md-consistency-gate.md#разработка) | Правка найденных расхождений в `CLAUDE.md` |
...
⚠️ **Номер фичи ищется в абзаце, а не в строке.** Запись `(фичи` / `[0026](../development/…), [0029](../development/…), обе в работе)` переносится, и построчный поиск её пропускал — именно
...
[0149-02](0149-claude-md-consistency-gate.md#разработка).
