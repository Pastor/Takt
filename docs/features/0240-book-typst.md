...
- **Related issues:** [Фича 0240](0240-book-typst.md); формат исходников
...
- **Влияние на порядок разработки:** фича **никого не блокирует формально**, но
  две незакрытые фичи правят **содержание** документа — [0222](0222-book-variables-const-fold.md)
  (раздел о переменных не отражает свёртку инициализатора) и
  [0237](0237-book-state-of-model-section.md) (раздел «Импорты» не
