...
- **Related issues:** [Фича 0051](0051-verify-scope.md); продолжает
  [ADR 0049](0049-model-checking-ltl.md#архитектура-adr) (открытый вопрос 2 стадии тестирования)
...
| Задача | Содержание |
|---|---|
| [0051-01](0051-verify-scope.md#разработка) | Признак `origin` в `ModelNode` + простановка в трёх формах импорта |
| [0051-02](0051-verify-scope.md#разработка) | Область в `verify_all` + флаг CLI `--scope` + вывод пропущенных |
...
[0051-02](0051-verify-scope.md#разработка).
...
импортированные (признак появился задачей [0051-01](0051-verify-scope.md#разработка), но
...
- **Признак происхождения, а не суррогат** (`ModelOrigin` + поле
  `ModelNode::origin`, задача [0051-01](0051-verify-scope.md#разработка)).
...
- **Отсечение поддеревом, а не поузлово** (задача
  [0051-02](0051-verify-scope.md#разработка)): вложенные модели чужого файла
