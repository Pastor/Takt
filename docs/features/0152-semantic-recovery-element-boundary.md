...
- **Related issues:** [Фича 0152](0152-semantic-recovery-element-boundary.md); прямое продолжение [ADR 0130](0130-diagnostics-batch.md#архитектура-adr) (Option C, отложен); смежные — [фича 0155](0155-semantic-nested-statement-resolution.md) (нельзя глотать ошибку разрешения оператора), [фича 0151](0151-diagnostics-batch-within-check.md) (накопление внутри отдельной проверки `validate`)
...
territory фичи [0151](0151-diagnostics-batch-within-check.md);
...
что закрыла [0202](0202-fmt-diagnostic-formatting.md), но в другом
месте. Тоже кандидат.
...
- Накопление **внутри** отдельной проверки `validate` — это фича
  [0151](0151-diagnostics-batch-within-check.md), другой слой.
...
- **Влияние на порядок:** ничего не разблокирует.
  [0151](0151-diagnostics-batch-within-check.md) (накопление внутри
...
[отчёт](0152-semantic-recovery-element-boundary.md#отчёт-о-тестировании), задача
[`0152-01`](0152-semantic-recovery-element-boundary.md#разработка).
