...
- **Related issues:** [Фича 0155](0155-semantic-nested-statement-resolution.md);
  смежные — [ADR 0129](0129-semantic-deep-nesting.md#архитектура-adr) (сторож глубины `SE-062`),
  [ADR 0130](0130-diagnostics-batch.md#архитектура-adr) (несколько диагностик за прогон)
...
- **A-2.** Терминальность стадий построения (ADR 0130) распространяется на
  ...
  [0151](0151-diagnostics-batch-within-check.md), не этой.
...
|---|---|
| [`0155-01`](0155-semantic-nested-statement-resolution.md#разработка) | Снять глотание в шести точках `statement.rs`; переписать устаревший док-комментарий модуля |
| [`0155-02`](0155-semantic-nested-statement-resolution.md#разработка) | Сторожа: фикстуры + тесты на все шесть точек, тест достижимости `SE-062` для операторов, тест доставки диагностики в LSP |
| [`0155-03`](0155-semantic-nested-statement-resolution.md#разработка) | Документ `book/` (правило 24) и актуализация `CLAUDE.md`/`CHANGES.md`/`README.md` |
...
- Сторожа — задача [0155-02](0155-semantic-nested-statement-resolution.md#разработка).
