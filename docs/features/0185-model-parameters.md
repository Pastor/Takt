...
- **Связанные issue (анализ):** запрос заказчика 2026-07-29 (дважды уточнён им же в тот же день: форма объявления; аргументы-выражения); снимает ограничение О8 анализа [0182](0182-pid-library-and-application.md) («параметризации моделей нет»)
...
**Четыре уточнения заказчика, определяющие форму** (2026-07-29):
