...
⚠️ **Проверка стоит в ОБОИХ обходах** — выражений и условий: печатников (и
обходов) у них два (урок 0359), и правка одного чинит половину входов.

### Задача 0394-02: реестр и документ
...
⚠️ **Два чужих набора пришлось поправить**, и оба — законно: тест 0262
...
## Уточнение границы (замер 2026-08-23)

⚠️ **ADR называла границей «переменный индекс» — такой формы в языке НЕТ.**
...
⚠️ Два чужих набора тестов поправлены: 0262 ждал отказа цели (теперь отвечает
