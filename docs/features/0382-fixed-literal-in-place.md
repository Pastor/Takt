...
- **Related issues:** [Фича 0382](0382-fixed-literal-in-place.md);
  продолжает [ADR 0381](0381-fixed-literal-in-body.md#архитектура-adr), опирается на носитель
  типа базы [ADR 0358](0358-postfix-index-on-expression.md#архитектура-adr) и на вывод типа поля
  [ADR 0371](0371-fixed-cast-from-field.md#архитектура-adr)

### Context

Фича [0061](0061-fixed-point-type.md) задала правило: дробный
...
[0381](0381-fixed-literal-in-body.md) распространила правило с
...
- **Зависит от:** нет. Опорные фичи закрыты: [0061](0061-fixed-point-type.md)
  (представление `q`), [0358](0358-postfix-index-on-expression.md)
  (носитель типа базы), [0371](0371-fixed-cast-from-field.md)
  (тип поля в выводе типов), [0381](0381-fixed-literal-in-body.md)
