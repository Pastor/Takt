...
- **Зависит от:** `нет` (проставлено аналитиком, стадия 3, 2026-07-16).
  ...
  Обоснование — в [анализе](../analyze/0048-deterministic-codegen.md), раздел
  «Зависимости фичи».
...
[0048-01](../development/0048-01-ordered-semantic-layer.md)…[0048-04](../development/0048-04-regenerate-examples.md)):
...
Детали — в [отчёте о тестировании](../reports/0048-deterministic-codegen.md) и
[анализе](../analyze/0048-deterministic-codegen.md). Исправлений (`docs/fixes/`)
не потребовалось.
