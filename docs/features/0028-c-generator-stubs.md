...
- **Related issues:** [Фича 0028](0028-c-generator-stubs.md);
  связь с [ADR 0025](0025-simulator-expression-eval.md#архитектура-adr) — **тот же класс дефекта**
  («тихий пропуск»), но в генераторе C, а не в симуляторе; пересечение по коду с
  [0027](0027-module-size-split.md#архитектура-adr) (делит `c_expr.rs`) и
  [0029](0029-c-type-mapping.md#архитектура-adr) (правит `generator/c/`)
...
[0025](0025-simulator-expression-eval.md#анализ)*.
...
Решение — [ADR 0028](0028-c-generator-stubs.md#архитектура-adr), **Option B**: для №1 —
...
> [0029](0029-c-type-mapping.md) заняла `CC-014`…`CC-017`. Проверка
...
| Фикстуры и тесты | **отдельно** | задача [`0028-03`](0028-c-generator-stubs.md#разработка) |
| Мёртвая ветка `//FIXME` | **отдельно** | задача [`0028-02`](0028-c-generator-stubs.md#разработка) |
...
Тесты — в задаче [`0028-03`](0028-c-generator-stubs.md#разработка).
...
> известная недетерминированность генерации, а не дефект 0028.
>
...
**Порядок.** Задача выполняется **после** [`0028-01`](0028-c-generator-stubs.md#разработка)
и [`0028-02`](0028-c-generator-stubs.md#разработка): до них тесты `float_bit_access_*`
...
предупреждений не добавлено** (фон 120 — объём фичи [0046](0046-build-warnings-cleanup.md)).
...
3. **Потребовалась правка печати CLI, в план не входившая.** Анализ считал канал
   ...
   [0026](0026-c-root-typedef.md#отчёт-о-тестировании): расхождение веток — причина того, что одна
