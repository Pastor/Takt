...
- **Related issues:** [Фича 0087](0087-invariant-soft-mode.md); продолжение [0044](0044-sim-assert-invariant.md#архитектура-adr) (инварианты в симуляторе, `SIM-025`)

### Context

Ядро [0044](0044-sim-assert-invariant.md#архитектура-adr) при нарушении инварианта (`invariant Имя
...
- **Зависит от:** **нет.** Ядро инвариантов ([0044](0044-sim-assert-invariant.md))
...
Ядро [0044](0044-sim-assert-invariant.md): нарушение инварианта
...
Реализована **Option A** [ADR 0087](0087-invariant-soft-mode.md#архитектура-adr).
...
[ADR 0087](0087-invariant-soft-mode.md#архитектура-adr): симулятор получил **мягкий режим**
