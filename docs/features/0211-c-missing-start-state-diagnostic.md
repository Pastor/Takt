...
- **Related issues:** [Фича 0211](0211-c-missing-start-state-diagnostic.md);
  родственные решения — [ADR 0199](0199-model-implements-brace-form.md#архитектура-adr) (форма
  `model M = A | B { … }`), фикс
