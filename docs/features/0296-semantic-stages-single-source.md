...
- **Related issues:** [Фича 0296](0296-semantic-stages-single-source.md); порядок стадий и накопление диагностик — [ADR 0130](0130-diagnostics-batch.md#архитектура-adr), [0152](0152-semantic-recovery-element-boundary.md#архитектура-adr); специализация параметров — [ADR 0185](0185-model-parameters.md#архитектура-adr); усыновление импорта — [фича 0184](0184-imported-shared-variables.md); класс «два списка одного набора» — [0084](0084-address-map-qualified-key.md), [0193](0193-shared-const-qualified.md), [0195](0195-target-name-collisions.md)
...
[0296-01](0296-semantic-stages-single-source.md#разработка),
[0296-02](0296-semantic-stages-single-source.md#разработка),
[0296-03](0296-semantic-stages-single-source.md#разработка).
