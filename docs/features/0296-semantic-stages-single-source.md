...
- **Tier:** 3 — две копии порядка стадий — расхождение даст импорту иной разбор (расставлен по признаку вреда 2026-08-18, см. `FEATURES.md`)
- **Класс:** семантика
...
| Разработка | [`docs/development/`](../development/README.md) (задачи `0296-YY-*`) |
| Тест-план | [`docs/tests/README.md`](../tests/README.md) |
| Отчёт о тестировании | [`docs/reports/README.md`](../reports/README.md) |
| Исправления | [`docs/fixes/`](../fixes/README.md) (при необходимости `0296-YY-*`) |
