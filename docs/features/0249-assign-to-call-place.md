...
- **Related issues:** [Фича 0249](0249-assign-to-call-place.md);
  находка гейта заглушек — [ADR 0217](0217-stub-branch-gate.md#архитектура-adr);
  позиции присваивания — [ADR 0187](0187-port-io-redesign.md#архитектура-adr) и фикс
  [0187-01](../fixes/0187-01-assignment-is-statement-in-grammar.md);
  образец «обход доставляет, судья решает» — [ADR 0188](0188-port-direction-everywhere.md#архитектура-adr),
  [ADR 0203](0203-validate-formulas-traversal.md#архитектура-adr);
  образец «молчаливый успех — худший ответ» — [ADR 0211](0211-c-missing-start-state-diagnostic.md#архитектура-adr)

### Context

Фича [0187](0187-port-io-redesign.md#архитектура-adr) нормировала **позиции** присваивания:
...
- **Зависит от:** **нет**. Проверено по трём осям:
  - **контракт судьи** — обход `validate/bodies.rs` существует и закрыт
    (фича [0188](0188-port-direction-everywhere.md), `ГОТОВО`);
    точка подключения `check_expr` уже отдаёт выражение двум судьям, третий
    добавляется рядом;
  - **позиция присваивания** — фича
    [0187](0187-port-io-redesign.md) (`ГОТОВО`) и фикс 0187-01
...
[0243](0243-type-redefinition-diagnostic.md); по правилу 22 подъём
...
зарегистрирована фичей [0250](0250-bit-write-in-targets.md), и
...
[0250](0250-bit-write-in-targets.md).
...
[задаче 0249-01](0249-assign-to-call-place.md#разработка).
