...
- **Статус:** **ГОТОВО** (закрыта 2026-07-15). Оба вопроса, блокировавшие
  ...
  [отчёт](../reports/0029-c-type-mapping.md).
...
> Полные результаты — в [отчёте](../reports/0029-c-type-mapping.md).
...
1. **Версия языка: 0.3.0.** Открытый вопрос 2
   [анализа](../analyze/0029-c-type-mapping.md) решён: фича **считается**
