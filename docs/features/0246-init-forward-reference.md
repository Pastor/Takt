...
- **Related issues:** [Фича 0246](0246-init-forward-reference.md); повод —
  проба при взятии [0222](0222-book-variables-const-fold.md);
  свёртка инициализатора — [0192](0192-const-init-fold.md).

### Context

Фича [0192](0192-const-init-fold.md) ввела правило: имя переменной
...
точки (фича [0204](0204-const-ref-type-inference.md)). Дефект
...
3. **Документируемость.** Фича [0222](0222-book-variables-const-fold.md)
...
- Фича [0222](0222-book-variables-const-fold.md) получает право
...
Исполнить уже принятое правило [0192](0192-const-init-fold.md):
...
- **Влияние на порядок разработки:** разблокирует
  [0222](0222-book-variables-const-fold.md) — та описывает свёртку
...
(подъём сделала [0243](0243-type-redefinition-diagnostic.md), тега
...
(прецедент — фича [0162](0162-git-tag-v040.md)), поэтому здесь
только фиксируется.
...
зелёный. Фича [0222](0222-book-variables-const-fold.md)
