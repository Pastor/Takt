# Фича 0291: Цели rust и sv считают неразрешённое условие отсутствием условия

- **Номер:** 0291
- **Статус:** СОЗДАНА
- **Зависит от:** не проставлено (стадия 3, правило 17)
- **Tier:** 1 — ветвь «Unresolved = безусловное» даёт валидный вывод с ДРУГИМ автоматом (расставлен по признаку вреда 2026-08-18, см. `FEATURES.md`)
- **Класс:** генерация
...
| Разработка | [`docs/development/`](../development/README.md) (задачи `0291-YY-*`) |
| Тест-план | [`docs/tests/README.md`](../tests/README.md) |
| Отчёт о тестировании | [`docs/reports/README.md`](../reports/README.md) |
| Исправления | [`docs/fixes/`](../fixes/README.md) (при необходимости `0291-YY-*`) |
