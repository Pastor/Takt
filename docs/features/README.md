...
| [0021](./0021-swap-assign-compare.md) | Смена операторов: `<=` присваивание, `=` сравнение | [ADR](../adr/0021-swap-assign-compare.md) · [анализ](../analyze/0021-swap-assign-compare.md) | АНАЛИЗ |
