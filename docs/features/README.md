...
| [0020](./0020-port-address-decl.md) | Адрес порта: размещение + потребление (карта адресов) | [ADR](../adr/0020-port-address-decl.md) · [анализ](../analyze/0020-port-address-decl.md) · [dev 01](../development/0020-01-address-grammar.md) | РАЗРАБОТКА |
