...
| [0021](./0021-swap-assign-compare.md) | Смена операторов: `:=` присваивание, `=` сравнение | [ADR](../adr/0021-swap-assign-compare.md) · [анализ](../analyze/0021-swap-assign-compare.md) · [dev 01–04](../development/0021-01-lexer-grammar.md) · [тест-план](../tests/0021-swap-assign-compare.md) | РАЗРАБОТКА |
