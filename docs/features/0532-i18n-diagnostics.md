...
- **Tier:** — (шкала «признак вреда» описывает дефекты вывода; здесь новая возможность — предложено оставить прочерк, решение заказчика)
...
задачи `0532-01`…`0532-07`). Все стадии — **разделы этой карточки** (правило 32): «Архитектура (ADR)»,
