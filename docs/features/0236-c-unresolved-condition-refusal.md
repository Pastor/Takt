...
- **Date:** 2026-08-16
- **Authors:** Архитектор
- **Related issues:** [Фича 0236](0236-c-unresolved-condition-refusal.md); находка [фичи 0203](0203-validate-formulas-traversal.md) (validate не обходил формулы); смежно с [ADR 0028](0028-c-generator-stubs.md#архитектура-adr) (отказ вместо комментария-заглушки), [ADR 0189](0189-anonymous-ports.md#архитектура-adr) (оператор терялся молча), [ADR 0229](0229-format-unsupported-position.md#архитектура-adr) (`FM-001` — один код, вид узла в тексте, позиция из АСД)
...
точности класс, ради которого заведён [ADR 0028](0028-c-generator-stubs.md#архитектура-adr)
...
1. **Молчаливая потеря недопустима.** Класс [0028](0028-c-generator-stubs.md#архитектура-adr) /
   [0155](0155-semantic-nested-statement-resolution.md) /
   [0189](0189-anonymous-ports.md#архитектура-adr): язык принимает запись, а диагностику даёт
...
4. **Диагностика обязана нести позицию** (правило пачки, фича
   [0130](0130-diagnostics-batch.md)): в сообщении без координаты
...
5. **И код** — «диагностика цели `c` без кода» уже заведена фичей
   [0212](0212-c-diagnostic-without-code.md) как отдельный класс;
...
- Образец уже есть в проекте и оправдал себя: `format::unsupported(loc, вид)` →
  `FM-001` (фича [0229](0229-format-unsupported-position.md#архитектура-adr)) — **один** код,
...
[0212](0212-c-diagnostic-without-code.md), а `unreachable!` в
...
- **Зависит от:** нет. Фича [0203](0203-validate-formulas-traversal.md)
  (источник находки) закрыта; общих контрактов с незакрытыми фичами нет.
  Смежная [0212](0212-c-diagnostic-without-code.md) («диагностика
...
[0168](0168-generator-warnings-return.md) (доставка диагностик
...
- **Р4. Мёртвая ветвь и её судьба.** Отказ недостижим, пока недостижимость
  ...
  [0217](0217-stub-branch-gate.md) («ветвь-заглушка переживает
...
1. **Класс закрыт для трёх узлов, несущих позицию.** Границы названы, а не
   ...
   [0212](0212-c-diagnostic-without-code.md).
...
[отчёте](0236-c-unresolved-condition-refusal.md#отчёт-о-тестировании); фиксов не
потребовалось.
