...
- **Related issues:** [Фича 0082](0082-unused-formulas.md); выявлено при [0035](0035-ltl-in-blocks.md); обострено [0081](0081-lamc-print-warnings.md) (Ce13 теперь печатается пользователю)
...
- **Обострено [0081](0081-lamc-print-warnings.md):** Ce13 теперь
