...
- **Related issues:** [Фича 0212](0212-c-diagnostic-without-code.md);
  образцы решения — [ADR 0236](0236-c-unresolved-condition-refusal.md#архитектура-adr)
  (воронка `CC-023`), [ADR 0229](0229-format-unsupported-position.md#архитектура-adr)
  (`FM-001`: один код, вид узла назван словом, позиция у узла),
  [ADR 0231](0231-diagnostic-text-no-debug.md#архитектура-adr) (в тексте диагностики нет
...
- **Сторож машинный:** греп по `takt-lang/src/generator/` в
  `takt-lang/tests/targets/c_diagnostic_code_tests.rs` — гейт кодов этот класс не видит
