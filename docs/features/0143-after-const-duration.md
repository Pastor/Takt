...
- **Related issues:** [Фича 0143](0143-after-const-duration.md); смежно
  с [ADR 0134](0134-language-time-model.md#архитектура-adr) (модель времени: `clock`, `after`, `every`),
  [ADR 0042](0042-address-defines.md#архитектура-adr) (вычисление константного выражения адреса —
...
принята [ADR 0143](0143-after-const-duration.md#архитектура-adr), Option A: имя
...
- **Зависит от:** `нет`. Проверено по контракту и инфраструктуре:
  ...
  - насыщение fixed-point ([0170](0170-fixed-point-saturation.md)) к
    длительностям отношения не имеет;
  - ограничение глубины ([0156](0156-parser-depth-limit.md)) не
...
- **Три находки проб** зафиксированы вне объёма фичи:
  1. **фича-преемник [0183](0183-duration-type-in-targets.md)** — тип
...
[0143-01](0143-after-const-duration.md#разработка),
[0143-02](0143-after-const-duration.md#разработка),
[0143-03](0143-after-const-duration.md#разработка),
[0143-04](0143-after-const-duration.md#разработка). Исправлений не
потребовалось.
