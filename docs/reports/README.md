...
| 0025 | Починка вычислителя выражений симулятора | [0025-simulator-expression-eval.md](0025-simulator-expression-eval.md) | ⚠️ НА ДОРАБОТКУ — Д1–Д8 закрыты, регресса нет, но не выполнены пункты тест-плана: фикстуры, интеграционный слой, перенос примеров в README, автосверка с C |
