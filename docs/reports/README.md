...
| 0029 | Генератор C: отображение типов Array/Bit/Rational | [0029-c-type-mapping.md](0029-c-type-mapping.md) | ⚠️ готова к закрытию — **два вопроса заказчику**: версия языка (0.3.0?) и конфликт кода `CC-014` с фичей 0028 |
