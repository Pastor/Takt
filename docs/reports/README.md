...
| 0090 | CI прогоняет весь `precheck.sh` (живые гейты + check-links) | [0090-ci-precheck.md](0090-ci-precheck.md) | ⏳ ТЕСТИРОВАНИЕ (T1,T4–T10 локально ✅; строгий `precheck.sh` EXIT=0, 110 строк гейтов, ST 8/8; T2/T3/T11 ожидают прогона Actions) |
