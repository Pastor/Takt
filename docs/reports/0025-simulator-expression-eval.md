...
> **Повторная проверка после доработки (задача [0025-07](../development/0025-07-c-conformance-test.md)).**
...
|---|---|---|
| 1. Фикстуры | [`0025-06`](../development/0025-06-fixtures-integration-tests.md) | 12 фикстур `simulation/tests/data/eval/` — проверка воспроизводима |
| 2. Интеграционный слой | [`0025-06`](../development/0025-06-fixtures-integration-tests.md) | `simulation/tests/eval_tests.rs`, 13 тестов на **значения**; добавлен `Unit::variable` (значения были ненаблюдаемы извне) |
| 3. Примеры в документации | [`0025-08`](../development/0025-08-readme-examples.md) | Разделы 6 и 7 `README.md`; каждый пример **прогнан**, тексты диагностик совпали дословно |
| 4. Автосверка с `lamc -t c` | [`0025-07`](../development/0025-07-c-conformance-test.md) | `conformance_c_tests.rs`; проверена негативно; **нашла Н6** |
