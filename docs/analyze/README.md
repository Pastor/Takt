...
| 0334 | Сдвиг на величину не меньше ширины типа в цели rust | [0334-rust-variable-shift-width.md](0334-rust-variable-shift-width.md) | — (новая фича) |
...
| 0343 | Инициализатор массива: st терял молча, c и rust порождали невалидное | [0343-array-initializer.md](0343-array-initializer.md) | — (новая фича) |
| 0344 | Порядок функций у цели st — по зависимостям вызова | [0344-st-call-order.md](0344-st-call-order.md) | — (новая фича) |
...
| 0364 | Вложенный массив у цели c | [0364-c-nested-array.md](0364-c-nested-array.md) | — (новая фича) |
...
| 0371 | Приведение q из поля структуры масштабируется | [0371-fixed-cast-from-field.md](0371-fixed-cast-from-field.md) | — (новая фича) |
| 0372 | Составной элемент массива в параметре функции | [0372-composite-array-parameter.md](0372-composite-array-parameter.md) | — (новая фича) |
| 0373 | Локальная переменная структурного типа у цели sv | [0373-sv-struct-local.md](0373-sv-struct-local.md) | — (новая фича) |
| 0374 | Приведение, совпадающее после отображения типа | [0374-mapped-type-cast.md](0374-mapped-type-cast.md) | — (новая фича) |
| 0375 | Частично использованная локальная структура у цели sv | [0375-sv-partial-struct-local.md](0375-sv-partial-struct-local.md) | — (новая фича) |
| 0376 | Неиспользуемая локальная переменная гасится заглушкой | [0376-unused-local-stub.md](0376-unused-local-stub.md) | — (новая фича) |
...
| 0383 | Приведение дробного литерала к q(m, n) в теле | [0383-fixed-cast-literal-in-body.md](0383-fixed-cast-literal-in-body.md) | — (новая фича) |
| 0384 | Приведение имени константы к q(m, n) | [0384-fixed-cast-const.md](0384-fixed-cast-const.md) | — (новая фича) |
| 0385 | Слово from — контекстное ключевое | [0385-contextual-from.md](0385-contextual-from.md) | — (новая фича) |
| 0386 | SE-036 видит локальные объявления тел | [0386-unused-local-warning.md](0386-unused-local-warning.md) | — (новая фича) |
