...
| `0025-02b` | Интерпретатор операторов (поток управления в `Execution`; `Loop`/`For`/`Match`/`Variable`/`Return`/`Break`/`Continue`); вызовы `Local`-`fn`; трактовка `extern fn` | Д3, Д4 | 01, 02a |
...
> Подробности — в [`0025-02a`](../development/0025-02a-expression-adapter.md).
