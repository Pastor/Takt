# Анализ фичи 0026: Устранение всех предупреждений сборки (rustc + clippy)

> Фича: [../features/0026-build-warnings-cleanup.md](../features/0026-build-warnings-cleanup.md) · ADR: [../adr/0026-build-warnings-cleanup.md](../adr/0026-build-warnings-cleanup.md) · тест-план: [../tests/README.md](../tests/README.md)
...
в [карточке фичи](../features/0026-build-warnings-cleanup.md).
...
<!-- Правило 17: при большом объёме декомпозировать на docs/analyze/0026-YY-slug.md. -->
