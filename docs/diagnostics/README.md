...
| `SE-093` | Начальное значение выходного порта **пока** не выставляется целями генерации (предупреждение; снимается задачами 0187-03…05, фича 0187) | `takt-lang/src/semantic/validate/port_init.rs` |
