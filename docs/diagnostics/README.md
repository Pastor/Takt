...
| `SE-091` | Инициализатор порта задаёт **адрес**, а не начальное значение: адрес 0/1 почти наверняка написан по привычке (предупреждение, фича 0176) | `takt-lang/src/semantic/port_address_hint.rs` |
