...
| `SIM-020` | Встроенная функция в позиции выражения пока не поддерживается симулятором (`S(Модель)`; вычислимые исполняются с фичи 0248) | `takt-sim/src/unit/statement.rs:538` |
