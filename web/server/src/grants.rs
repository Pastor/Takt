...
async fn fork(
    ...
    let source = transaction
        .query_one(
            "SELECT name, takt_lang, language_version, main_file, main_scenario,
                    owner_id, build_target, build_args, run_delays, run_frequencies, run_watch
    ...
    let run_frequencies: String = source.get("run_frequencies");
    let run_watch: String = source.get("run_watch");
    transaction
        .execute(
            "INSERT INTO projects(id, owner_id, name, description, visibility,
                                  ...
                                  run_watch, revision, size_bytes, forked_from, created_at,
                                  updated_at, touched_at)
             VALUES ($1, $2, $3, '', 'private', $4, $5, $6, $7, $8, $9, $10, $11, $12, 0, 0, $13,
                     $14, $14, $14)",
            &[
                &copy,
                &user.id,
